          ...
          function () {
            ...
            var ye = (function t(n) {
              ...
              function Rr(t) {
                ...
                var n = [];
                for (var e in Tt(t))
                  jt.call(t, e) && "constructor" != e && n.push(e);
                return n;
              }
              function Mr(t) {
                if (!na(t))
                ...
                var n = Eo(t),
                  e = [];
                for (var r in t)
                  ("constructor" != r || (!n && jt.call(t, r))) && e.push(r);
                return e;
              }
              function Fr(t, n) {
                return t < n;
              ...
              function hi(t, n) {
                return (
                  null == (t = Lo(t, (n = bi(n, t)))) || delete t[Mo(Jo(n))]
                );
              }
              function pi(t, n, e, r) {
              ...
              ((Ee && go(new Ee(new ArrayBuffer(1))) != U) ||
                (ke && go(new ke()) != E) ||
                (Te && go(Te.resolve()) != C) ||
                (Ce && go(new Ce()) != B) ||
                (Le && go(new Le()) != z)) &&
              ...
              var au = Jr(function (t, n) {
                ...
                su = Jr(function (t) {
                  var n = Jo(t);
                  return (
                    (n = "function" == typeof n ? n : i), gi(zn(t, Ku), i, n)
                  );
                }),
                fu = Jr(ou);
              ...
              var Wu = Hi(Tr),
                ...
                $u = Or(
                  ...
                  : function (t) {
                      return (
                        ea(t) && jt.call(t, "callee") && !Zt.call(t, "callee")
                      );
                    },
                Vu = r.isArray,
                Gu = Sn
              ...
              function oa(t) {
                ...
                return (
                  "function" == typeof e && e instanceof e && Ut.call(e) == Nt
                );
              }
              var ua = En
                ? te(En)
              ...
              var ba = zi(function (t, n) {
                  ...
                  else for (var e in n) jt.call(n, e) && er(t, e, n[e]);
                }),
                wa = zi(function (t, n) {
                  Ii(n, za(n), t);
                }),
              ...
              var Ea = Jr(function (t, n) {
                  ...
                  for (o && wo(n[0], n[1], o) && (r = 1); ++e < r; )
                    for (
                      var u = n[e], a = za(u), c = -1, l = a.length;
                      ++c < l;

                    ) {
                      var s = a[c],
                        f = t[s];
                      (f === i || (Du(f, zt[s]) && !jt.call(t, s))) &&
                        (t[s] = u[s]);
                    }
                  return t;
                }),
              ...
              return (
                ...
                (De.throttle = function (t, n, e) {
                  ...
                  return (
                    ...
                    Ou(t, n, { leading: r, maxWait: n, trailing: i })
                  );
                }),
                (De.thru = du),
                (De.toArray = pa),
                ...
                (De.isEmpty = function (t) {
                  ...
                  for (var e in t) if (jt.call(t, e)) return !1;
                  return !0;
                }),
                ...
                (De.isMatchWith = function (t, n, e) {
                  return (
                    (e = "function" == typeof e ? e : i), Pr(t, n, fo(n), e)
                  );
                }),
                (De.isNaN = function (t) {
                  return ia(t) && t != +t;
                ...
                wr(Ve.prototype, function (t, n) {
                  ...
                  if (e) {
                    var r = e.name + "";
                    jt.call(Oe, r) || (Oe[r] = []),
                      Oe[r].push({ name: n, func: e });
                  }
                }),
                (Oe[Di(i, 2).name] = [{ name: "wrapper", func: i }]),
          ...
          return o().createElement(
            ...
            o().createElement(
              ...
              o().createElement(
                "li",
                { className: "account-selection-list-item" },
                o().createElement(T, { handleAddAccount: a, translate: c }),
              ),
            ),
          );
        },
          ...
          if ($())
            try {
              L.localStorageService.setLocalStorage(x, t),
                L.localStorageService.setLocalStorage(E, !0);
            } catch (t) {
              console.warn(t),
                I(
                  B.context.accountSwitcherLocalStorageFailure,
        ...
        nt = (0, c.withTranslations)(function (e) {
                          ...
                          U(void 0, void 0, Promise, function () {
                            ...
                            return j(this, function (e) {
                              switch (e.label) {
                                case 0:
                                  return (
                                    (t = R("/account-switcher/v1/switch")),
                                    (n = { url: t, withCredentials: !0 }),
          ...
          return nt
            ...
            : o().createElement(
                ...
                (null === (r = Z.usersAvailableForSwitching) || void 0 === r
                  ? void 0
                  : r.length) > 0 &&
                  o().createElement(C, {
                    users: Z.usersAvailableForSwitching,
