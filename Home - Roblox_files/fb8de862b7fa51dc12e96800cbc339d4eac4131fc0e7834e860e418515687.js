!(function () {
  ...
  var o = 1e4,
    ...
    y = function (t, i, n) {
      if (!n) {
        var r = {};
        (r.status = e.DETAILS_LOADING),
          (r.lastModifiedTimestamp = Date.now()),
          f.localStorageService.setLocalStorage(m(t, i), r),
          h(i, t);
      }
    },
    b = function (t, i, n, r) {
      if (!r) {
        var l = {};
        (l.status = e.DETAILS_HYDRATED),
          (l.details = n),
          (l.lastModifiedTimestamp = Date.now()),
          f.localStorageService.setLocalStorage(m(t, i), l),
          h(i, t);
      }
    },
    D = function (e) {
      ...
      null != t &&
        t.forEach(function (t) {
          var n = I(t, e);
          void 0 === (null == n ? void 0 : n.lastModifiedTimestamp) ||
          Date.now() - (null == n ? void 0 : n.lastModifiedTimestamp) > a
            ? f.localStorageService.removeLocalStorage(m(t, e))
            : i.push(t);
        }),
        f.localStorageService.setLocalStorage(p(e), i);
    },
          ...
          switch (n.label) {
            case 0:
              return (
                ...
                t <= 0 || e.length <= 0
                  ? [2, void 0]
                  : ((i = new Array()), [4, Promise.resolve(_(e))])
              );
            case 1:
              return (
                n.sent().data.data.forEach(function (e) {
                  i.push(
                    E(E({}, e), {
                      purchaseInfo:
                        void 0 === e.collectibleItemId ? L(e, void 0) : void 0,
                    }),
                  );
                }),
      ...
      return P(void 0, void 0, Promise, function () {
        ...
        return O(this, function (o) {
          switch (o.label) {
            case 0:
              return (
                ...
                t.forEach(function (t) {
                  ...
                  void 0 !== i && i.status === e.DETAILS_HYDRATED
                    ? n.push(i.details)
                    : r.push(t);
                }),
            ...
            case 2:
              return (
                ((l = o.sent()).hydratedItemDetails = n.concat(
                  l.hydratedItemDetails,
                )),
                [2, l]
              );
            case 3:
              return [2, { hydratedItemDetails: n, nonHydratedItemDetails: r }];
          }
        });
      });
    },
      ...
      return P(void 0, void 0, Promise, function () {
        ...
        return O(this, function (g) {
          switch (g.label) {
            case 0:
              return (
                ...
                t.forEach(function (t) {
                  var i = I(t.id, t.itemType);
                  null == i
                    ? (u.push(t), y(t.id, t.itemType, a))
                    : i.status === e.DETAILS_LOADING ||
                        i.status === e.DETAILS_NOT_HYDRATED
                      ? Date.now() - i.lastModifiedTimestamp > s
                        ? (u.push(t), y(t.id, t.itemType, a))
                        : d.push(t)
                      : Date.now() - i.lastModifiedTimestamp > o
                        ? (u.push(t), y(t.id, t.itemType, a))
                        : c.push(i.details);
                }),
            ...
            case 3:
              return (
                (m = g.sent()).hydratedItemDetails.forEach(function (e) {
                  c.push(e);
                }),
                m.nonHydratedItemDetails.length > 0
                  ? [4, Promise.resolve(C(d, 3))]
                  : [3, 5]
              );
            case 4:
              void 0 !== (p = g.sent()) &&
                ...
                v.length > 0 && n
                  ? [
                      ...
                      Promise.resolve(
                        ((P = v),
                        (O = { itemIds: P }),
                        r.httpService.post(l.postCollectibleItemDetails, O)),
                      ),
                    ]
                  : [3, 7]
              );
              ...
              for (
                D = g.sent(),
                  w = function (e) {
                    ...
                    void 0 !== i &&
                      ((t.purchaseInfo = L(i, t)),
                      (i.collectibleItemDetails = t),
                      b(i.id, i.itemType, i, a));
                  },
                  A = 0;
                A < D.data.length;
                A++
            ...
            case 7:
              return [4, x(c, h, 5)];
            case 8:
              for (g.sent(), A = 0; A < c.length; A++)
                (R = c[A]),
                  (S = I(R.id, R.itemType)) &&
                    (R.collectibleItemDetails =
                      S.details.collectibleItemDetails);
              return [2, c];
          }
          var P, O;
        });
  ...
  n().ItemDetailsHydrationService = { getItemDetails: H };
})();
