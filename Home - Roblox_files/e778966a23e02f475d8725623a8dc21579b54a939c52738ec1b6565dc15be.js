!(function () {
  ...
  var a = {
    ...
    w =
      ((y.prototype.sendEvent = function (e) {
        var n = e.localTime,
          t = e.target,
          a = e.eventType,
          o = e.context,
        ...
        return (
          i.searchParams.append("t", t),
          i.searchParams.append("evt", a),
          i.searchParams.append("ctx", o),
          i.searchParams.append("lt", n),
          i.searchParams.append("url", s || window.location.href),
          void 0 !== c && i.searchParams.append("gid", c),
          void 0 !== e && i.searchParams.append("sid", e),
          void 0 !== r &&
            Object.keys(r).forEach(function (e) {
              i.searchParams.append(
                e,
                (null !== (e = r[e]) && void 0 !== e ? e : "").toString(),
              );
            }),
          fetch(i.href, { credentials: "same-origin" })
        );
      }),
      (y.prototype.sendEventViaImg = function (e, n) {
        ...
        l.searchParams.append("t", a),
          l.searchParams.append("evt", o),
          l.searchParams.append("ctx", r),
          l.searchParams.append("lt", t),
          l.searchParams.append("url", c || window.location.href),
          void 0 !== i && l.searchParams.append("gid", i),
          void 0 !== e && l.searchParams.append("sid", e),
          void 0 !== s &&
            Object.keys(s).forEach(function (e) {
              l.searchParams.append(
                e,
                (null !== (e = s[e]) && void 0 !== e ? e : "").toString(),
              );
            });
        e = new Image();
        return (
  ...
  var b = function () {
    ...
    E = new w(
      new n({ baseUrl: "https://ecsv2." + c + "/AccessManagementUpsell" }),
    ),
    P = {
    ...
    return (
      (0, l.useEffect)(function () {
        window.addEventListener(
          g.OpenAccessManagementVerificationModal,
          function () {
            c(!0), P.sendEvent(M);
          },
          !1,
        ...
        d().createElement(
          ...
          d().createElement(
            ...
            d().createElement(
              ...
              d().createElement("span", { className: "icon-close" }),
            ),
            d().createElement(
              p.Modal.Title,
          ...
          d().createElement(p.Modal.Body, null, n(a)),
          d().createElement(
            p.Modal.Footer,
            null,
            d().createElement(
              p.Button,
              {
                ...
                onClick: function () {
                  return (
                    (e = u.Endpoints.getAbsoluteUrl(r)),
                    void (
                      "undefined" != typeof window &&
                      ((window.location.href = e), c(!1), P.sendEvent(U))
                    )
                  );
                  var e;
                },
  ...
  O.propTypes = { translate: i().func.isRequired };
  var T = O,
    A = (0, s.withTranslations)(
      function (e) {
        return (e = e.translate), d().createElement(T, { translate: e });
      },
  ...
  function I() {
    ...
    e
      ? (0, t.render)(d().createElement(A, null), e)
