// bundle: pageEnd___ce07ad47fe0caac7f7809926e9e5a6c2_m
...
Roblox.Lang["Authentication.Login"] = {
  ...
  "Response.InvalidPasskeyCredential": "Unable to sign in with this passkey.",
...
Roblox.Lang["VerificationUpsellResources"] =
  Roblox.Lang["Feature.VerificationUpsell"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ProfileBadgesResources_en_us_standard.js
...
Roblox.Lang["FeaturesResources"] = Roblox.Lang["CommonUI.Features"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_MessagesResources_en_us_standard.js
...
Roblox.Lang["RedeemGameCardResources"] =
  Roblox.Lang["Purchasing.RedeemGameCard"]; // ~/Generated/js/Roblox_TranslationResources_Feature_TrackingResources_en_us_standard.js
...
Roblox.Lang["TrackingResources"] = Roblox.Lang["Feature.Tracking"]; // ~/Generated/js/Roblox_TranslationResources_Notifications_NotificationStreamResources_en_us_standard.js
...
Roblox.Lang["Notifications.NotificationStream"] = {
  ...
  "Description.AudioRejected":
    "Our moderation team has removed your Audio ID: {ContentID}",
  "Description.AvatarAccessoryAppealUpdated":
    "Appeal request: Avatar Accessory ID: {ContentID}",
  "Description.AvatarAccessoryRejected":
    "Our moderation team has removed your Avatar Accessory ID: {ContentID}",
  "Description.BundleAppealUpdated": "Appeal request: Bundle ID: {ContentID}",
  "Description.BundleRejected":
    "Our moderation team has removed your Bundle ID: {ContentID}",
  ...
  "Description.ImageRejected":
    "Our moderation team has removed your Image ID: {ContentID}",
  "Description.MeshAppealUpdated": "Appeal request: Mesh ID: {ContentID}",
  "Description.MeshRejected":
    "Our moderation team has removed your Mesh ID: {ContentID}",
  "Description.ModelAppealUpdated": "Appeal request: Model ID: {ContentID}",
  "Description.ModelRejected":
    "Our moderation team has removed your Model ID: {ContentID}",
  ...
  "Error.MaxLength.AbuseReporterComment":
    "Please limit your comment to under {maxLength} characters.",
  "Error.ServerError.ReportNotification":
    "Reporting this notification failed. Please try again.",
  "Error.UnauthorizedUser.ReportNotification":
    "You do not have the required permission to report this notification.",
  "Heading.AppealUpdated": "Appeal Request Updated",
  "Heading.AudioAppealUpdated":
    "Your appeal on Audio (ID: {ContentID}) is updated",
  "Heading.AudioRejected": "Audio Removed",
  "Heading.AutomatedContentRemoval": "Automated Content Removal",
  "Heading.AvatarAccessoryAppealUpdated":
    "Your appeal on Avatar Accessory (ID: {ContentID}) is updated",
  "Heading.AvatarAccessoryRejected": "Avatar Accessory Removed",
  "Heading.BackToAllNotifications": "All Notifications",
  "Heading.BundleAppealUpdated":
    "Your appeal on Bundle (ID: {ContentID}) is updated",
  "Heading.BundleRejected": "Bundle Removed",
  "Heading.ExistingFollowerNotification": "New! Experience Notifications",
  "Heading.ImageAppealUpdated":
    "Your appeal on Image (ID: {ContentID}) is updated\n",
  "Heading.ImageRejected": "Image Removed",
  "Heading.JoinFailed": "Join Failed",
  "Heading.MeshAppealUpdated":
    "Your appeal on Mesh (ID: {ContentID}) is updated",
  "Heading.MeshRejected": "Mesh Removed",
  "Heading.ModelAppealUpdated":
    "Your appeal on Model (ID: {ContentID}) is updated",
  ...
  "Message.AggregatedGameUpdateMultiple":
    "{gameOne}, {gameTwo}, and {otherCount, plural, =1 {# other game} other {# other games}} sent updates.",
  "Message.ConfirmAcceptedDouble": "{userOne} and {userTwo}",
  "Message.ConfirmAcceptedMultiple":
    "{userOne}, {userTwo}, and {userMultipleCount, plural, =1 {# other} other {# others}}",
  ...
  "Message.ConfirmSentMultiple":
    "{userOne}, {userTwo}, and {userMultipleCount, plural, =1 {# other} other {# others}} are now your friends!",
  "Message.ConfirmSentSingle": "{userOne} is now your friend!",
  "Message.DefaultExperienceInviteMessage":
    "{displayName} is inviting you to join {experienceName}!",
  "Message.DefaultExperienceInviteTitle":
    "Invite from {displayName} @{username}",
  "Message.DeveloperMetricsAvailable":
    "{month} {year} Analytics Report for {gameName} available.",
  "Message.DeveloperMetricsAvailableMultiple2":
    "{month} {year} Analytics Report for {gameCount} experiences available.",
  "Message.FriendRequestAcceptedDouble":
    "{userOne} and {userTwo} accepted your friend request.",
  ...
  "Message.FriendRequestAcceptedSingle":
    "{userOne} accepted your friend request.",
  "Message.FriendRequestSentDouble":
    "{userOne} and {userTwo} sent you friend requests.",
  "Message.FriendRequestSentMultiple":
    "{userOne}, {userTwo}, and {userMultipleCount, plural, =1 {# other} other {# others}} sent you friend requests.",
  ...
  "Message.MessageAndPreview":
    "{titleStart}Message from {username}:{titleEnd} {message}",
  "Message.MessageFrom": "Message from {username}:",
  "Message.NumberofNewNotifications":
    "{notificationCount, plural, =1 {# New Notification} other {# New Notifications}}",
  "Message.SubscriptionGracePeriodLowBalanceWarning":
    "{subscriptionProductName} failed to renew. Redeem a code to keep your benefits.",
  "Message.SubscriptionRenewalLowBalanceWarning":
    "Your Roblox Credit is low. Redeem a code to renew {subscriptionProductName}.",
  "Message.TooManyFriendsOther":
    "That user already has the max number of friends.",
  "Message.TooManyFriendsSelf": "You already have the max number of friends.",
  "Message.TurnedOffNotifications":
    "You have turned off notifications for {experienceName}",
  ...
  "Message.YouHaveBeenAcceptedToNewGroups":
    "You have {numberOfGroups} new {numberOfGroups, plural, =1 {group} other {groups}}.",
  "Message.YouHaveNewFriendRequests":
    "You have {numberOfRequests} new {numberOfRequests, plural, =1 {friend request} other {friend requests}}.",
  "Message.YouHaveNewFriends":
    "You have {numberOfFriends} new {numberOfFriends, plural, =1 {friend} other {friends}}.",
  "Message.YouReceivedMessages":
    "You received {numberOfMessagesText} {numberOfMessages, plural, =1 {message} other {messages}}",
  ...
  "Placeholder.ReasonDescription":
    "In your own words, help us understand what went wrong.",
  "ReportedCard.Description":
    "We will review your report soon and take action if needed.",
...
Roblox.Lang["NotificationStreamResources"] =
  Roblox.Lang["Notifications.NotificationStream"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ReportAbuseResources_en_us_standard.js
...
Roblox.Lang["Feature.ReportAbuse"] = {
  ...
  "Label.CategoryAgeGuidelines":
    "Inaccurate Content Maturity (e.g. blood, violence)",
  ...
  "Label.IllegalContentDSA":
    "Report illegal content under the EU Digital Services Act.",
  ...
  "Label.MoreInfoAtRobloxSafetyLink":
    "For more information, check out {linkStart}Roblox Safety{linkEnd}.",
  ...
  "Label.Rules4":
    "No asking real life info about each other - no asking for phone numbers or email addresses",
  "Label.RulesHeading":
  ...
  "Label.TellUsHow":
    "Tell us how you think {creatorName} is breaking the rules of Roblox.",
  "Label.TellUsHowAsset":
    "Tell us how you think the asset is breaking the rules of Roblox.",
  "Label.ThanksForFlagging": "Thanks for flagging this asset.",
  "Message.ErrorAssetInfoNotLoaded":
    "The asset information could not be loaded, but you may still be able to submit a report.",
  "Message.ErrorCommentCharacterLimit":
    "Your comment must be less than {characterLimit} characters.",
  "Message.ErrorMissingParams":
    "One or more required parameters are missing or invalid",
  "Message.ErrorReportingCategories":
    "There was a problem loading reporting categories.",
  "Message.ErrorSubmit": "There was a problem submitting your report.",
  "Message.GenericError": "There was a problem with the page",
  "Message.ModCategoryHarmfulFunctionality":
    "Scripts should not damage the experience or confuse players\t",
  "Message.ModCategoryInappropriateContent":
    "No profanity, adult or discriminatory content",
  "Message.ModCategoryOther":
    "Inappropriate content & abuse reports (opens new page)",
  "Message.ModCategorySpam":
    "Multiple copies of similar assets don't add value to the community",
  "Message.OSACopy1":
    "We will review your report and take appropriate action. We will not share your information with any user you report.",
  "Message.OSACopy2":
  ...
  "Message.OSACopy3":
    "You can also report illegal content under the UK Online Safety Act.",
  "Message.Success": "Your report has been sent.",
  "Message.TellUsWhyAsset":
    "Tell us why this asset does not meet your expectations. Please include as much detail as possible.",
  "Message.ThanksForFlagging":
    "We are unable to respond to each report, but your feedback will help us improve the experience for all creators.",
  "Message.ThankYou":
  ...
  "OSAIllegal.ReportLink":
    "Report illegal content under the UK Online Safety Act.",
  "Response.PermissionError": "This account does not have enough permissions",
};
Roblox.Lang["ReportAbuseResources"] = Roblox.Lang["Feature.ReportAbuse"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ChatResources_en_us_standard.js
...
Roblox.Lang["Feature.Chat"] = {
  ...
  "Label.MuteConversationNotificationsForGroup":
    "Mute notifications for this chat group",
  ...
  "Label.SpanTitle.CreateGroupNeeds2More":
    "Add at least 2 people to create chat group",
  ...
  "Message.conversationTitleChangedText":
    "{userName} named the chat group: {groupName}",
  ...
  "Message.FindGameToPlay":
    "{frontLink}Find Experiences{endLink} to visit with your friends!",
  "Message.JoinPartyText":
    "The party leader is finding an experience to visit.",
  ...
  "Message.MessageFilterForReceivers":
    "Not everyone in this chat can see your message.",
  "Message.NoConnectionMsg": "Connecting...",
  "Message.PartyInviteMsg": "PARTY INVITE!",
  "Message.PinGameUpdate":
    "{userName} chose an experience to visit together: {gameName}",
...
Roblox.Lang["ChatResources"] = Roblox.Lang["Feature.Chat"]; // ~/Generated/js/Roblox_TranslationResources_Purchasing_PurchaseDialogResources_en_us_standard.js
...
Roblox.Lang["IdentityResources"] = Roblox.Lang["Verification.Identity"]; // ~/Generated/js/Roblox_TranslationResources_Feature_AgeVerificationUpsellResources_en_us_standard.js
...
Roblox.Lang["AgeVerificationUpsellResources"] =
  Roblox.Lang["Feature.AgeVerificationUpsell"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GameLaunchGuestModeResources_en_us_standard.js
...
Roblox.Lang["DownloadLandingResources"] =
  Roblox.Lang["Feature.DownloadLanding"]; // ~/Generated/js/Roblox_TranslationResources_CommonUI_UserAgreementsResources_en_us_standard.js
...
Roblox.Lang["UserAgreementsResources"] = Roblox.Lang["CommonUI.UserAgreements"]; // ~/Generated/js/Roblox_TranslationResources_Feature_IdVerificationResources_en_us_standard.js
...
Roblox.Lang["IdVerificationResources"] = Roblox.Lang["Feature.IdVerification"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ParentsResources_en_us_standard.js
...
Roblox.Lang["ParentsResources"] = Roblox.Lang["Feature.Parents"]; // ~/Generated/js/Roblox_TranslationResources_Feature_AccountSecurityPromptResources_en_us_standard.js
...
Roblox.Lang["Feature.AccountSecurityPrompt"] = {
  ...
  "Description.ChangeYourPassword":
    "To keep your account safe, please change your password.",
  ...
  "Header.KeepYourAccountSafeShort":
    "Keep Your Account Safe With Authenticator",
  "Header.SomeoneMightBeUsingYourAccount":
  ...
  "Label.AuthenticatorUpsellProtectRobuxHeadline":
    "Protect Your Experiences, Robux and More",
  ...
  "Message.Error.PasswordValidation.PasswordSameAsUsername":
    "Password must not be your username.",
  ...
  "Message.Error.PromptAssignments.Default":
    "An error occurred. Please try again later.",
};
Roblox.Lang["AccountSecurityPromptResources"] =
  Roblox.Lang["Feature.AccountSecurityPrompt"]; // ~/Generated/js/Roblox_TranslationResources_Feature_CatalogResources_en_us_standard.js
...
Roblox.Lang["Feature.Catalog"] = {
  ...
  "Label.SellPageUpsell":
    "Selling is only available to users with a Premium membership.",
  "Label.SerialNumber": "Serial Number",
...
Roblox.Lang["CatalogResources"] = Roblox.Lang["Feature.Catalog"]; // ~/Generated/js/Roblox_TranslationResources_Feature_PeopleListResources_en_us_standard.js
...
Roblox.Lang["PeopleListResources"] = Roblox.Lang["Feature.PeopleList"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_SocialResources_en_us_standard.js
...
Roblox.Lang["Authentication.Social"] = {
  ...
  "Description.AddPasswordModalSuccess":
...
Roblox.Lang["SocialResources"] = Roblox.Lang["Authentication.Social"]; // ~/Generated/js/Roblox_TranslationResources_Authentication_SignUpResources_en_us_standard.js
...
Roblox.Lang["Authentication.SignUp"] = {
  ...
  "Description.ContinueChildRequest":
    "Continue to complete your child's request. ",
  "Description.EnterParentEmail":
    "Enter your parent's email address to receive a verification code.",
  "Description.LoginWithEmail":
    "You can sign into your account anytime with your email address.",
  "Description.LogoutConfirmation":
    "You’ll need to log out of your other Roblox accounts on this device before adding a new account\t",
  ...
  "Description.SignupCompliance.PrivacyPolicyAck":
    "Acknowledge the {privacyPolicyLink}",
  "Description.SignupCompliance.TermsOfUse":
    "I have reviewed and agreed to the {termsOfUseLink}",
  ...
  "Description.Try": "Try",
  "Description.UnderAgeAlert":
    "You do not meet the minimum age requirement to play Roblox.",
  ...
  "Description.VerifiedParentalConsentEmail.Subject":
    "Approval Request To Sign Up For Roblox",
  "Description.VerifiedParentalConsentModal.EnterCode":
    "Enter the code we just sent to {email}",
...
Roblox.Lang["SignUpResources"] = Roblox.Lang["Authentication.SignUp"]; // ~/Generated/js/Roblox_TranslationResources_Feature_ContactUpsellResources_en_us_standard.js
...
Roblox.Lang["Feature.ContactUpsell"] = {
  ...
  "Description.ContactMethodAccessLoss":
    "Without a Contact Method, you may lose access to game progress, items, and Robux if your account is lost.",
  "Description.ContactMethodAccessLoss.V2":
    "Without a phone or email, you may lose access to game progress, items, and Robux if your account is lost.",
  "Description.FacebookSetPasswordUpsellText":
    "⚠️ We noticed you logged in with Facebook which is no longer supported. Please add a password so you don’t get locked out.",
  "Description.GetFeaturesWithPhone":
    "Get access to the newest Roblox features with phone verification.",
  "Description.HelpFriendsConnectWithYou":
    "Add your phone number to help your friends connect with you.",
  "Description.HomePageUpsellCardAddEmailText":
    "Add an email so you don't lose access to your Friends, Avatars and Robux.\t",
  "Description.HomePageUpsellCardAddPhoneOrEmailText":
    "Add your phone number or email so you don’t lose access to your friends, avatars and Robux.",
  "Description.HomePageUpsellCardAddPhoneText":
    "Add your phone number so you don’t lose access to your friends, avatars and Robux.",
  "Description.PhoneNumbersPrivacyVisibility":
    "You phone number will never be displayed publicly.",
  "Description.ProtectAccountDescriptiveNorm.V1":
    "Join millions of users who have verified their phone numbers to protect their accounts.",
  "Description.ProtectAccountDescriptiveNorm.V2":
    "Join millions of users who have verified their Phone Numbers to enjoy helpful features.",
  "Description.UnlockVoiceChat":
    "Join millions of users who have verified their Phone Numbers to chat with voice.",
  "Description.UnlockVoiceChat.2":
    "Add a phone number to chat using voice. After adding the phone number, enable Voice in Settings > Privacy.",
  "Description.UnlockVoiceChat.3": "Add a phone number to enable Voice Chat.",
  "Description.UnlockVoiceChat.4":
    "Talk with others and have more fun. Add a phone number to get started.",
  "Description.UnlockVoiceChat.5":
    "Level up your experience with real-time collaboration. Add a phone number to get started.",
  "Description.UpsellBodyUnlock.V1":
    "Add your phone number now to unlock helpful features and enhanced security.",
  "Description.VerificationCodeSmsFeesMayApply":
    "We will text you a verification code. SMS fees may apply.",
  ...
  "Heading.KeepAccountSecure": "Keep Your Account Secure",
  "Heading.LetFriendsFindYou": "Let Your Friends Find You",
  "Heading.PhoneVerifiedGetMoreFeatures":
    "Phone Verified Users Get More Features",
  ...
  "Label.ProtectAccountWithParentsEmail":
    "Protect your account with your parent's email!",
  "Label.ProtectAccountWithPhone": "Protect your account with a phone number!",
  "Label.RecoverIfPasswordLost":
    "Recover your account in case you lose your password.",
  "Label.RecoverYourAccount":
    "Recover your account easily in case you lose your password.",
  ...
  "Label.VerifyParentsEmailToProtectAccount":
    "Verify your parent's email to protect your account!",
  ...
  "Response.Dialog.AddEmailForFreeHatOver13":
    "Please add your email to receive a free hat and ensure that you never get locked out of your account!",
  ...
  "Response.Dialog.AddEmailInstructionsOver13":
    "Please enter your email address. We will send a link to complete verification.",
  "Response.Dialog.AddEmailInstructionsUnder13":
    "Please enter your parent's email address. We will send a link to complete verification.",
  "Response.Dialog.AddEmailOver13":
    "Please add an email address to your account to ensure that you can always access your Roblox account.",
  "Response.Dialog.AddEmailUnder13":
    "Please add your parent's email address to your account to ensure that you can always access your Roblox account.",
  "Response.Dialog.AddPhone":
    "Please add a phone number to your account to ensure that you never get locked out of your account.",
  "Response.Dialog.AddPhoneForFreeHat":
    "Please add your phone number to receive a free hat and ensure that you never get locked out of your account!",
  ...
  "Response.Dialog.ConfirmEmailForFreeHatOver13":
    "Remember to confirm your email address to receive the free hat!",
  "Response.Dialog.ConfirmEmailForFreeHatUnder13":
    "Remember to confirm your parent's email address to receive the free hat!",
  "Response.Dialog.ContactFriendFinderPhoneUpsell":
    "Please add a phone number to your account so that your friends can find you!",
  "Response.Dialog.EnterCodeInstructions":
    "Enter the code in the text sent to {phoneNumber}",
  "Response.Dialog.FreeHatForAddingPhone":
    "Your phone number has been confirmed. Enjoy the free hat!",
  ...
  "Response.Dialog.VerifyEmailOver13":
    "Please verify your email address to ensure that you can always access your Roblox account.",
  "Response.Dialog.VerifyEmailUnder13":
    "Please verify your parent's email address to ensure that you can always access your Roblox account.",
...
Roblox.Lang["ContactUpsellResources"] = Roblox.Lang["Feature.ContactUpsell"]; // ~/Generated/js/Roblox_TranslationResources_Common_GameSortsResources_en_us_standard.js
...
Roblox.Lang["PlacesListResources"] = Roblox.Lang["Feature.PlacesList"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GameDetailsResources_en_us_standard.js
...
Roblox.Lang["GameDetailsResources"] = Roblox.Lang["Feature.GameDetails"]; // ~/Generated/js/Roblox_TranslationResources_Feature_GamePageResources_en_us_standard.js
...
Roblox.Lang["GamePageResources"] = Roblox.Lang["Feature.GamePage"]; // ~/Generated/js/Roblox_TranslationResources_Feature_HomeResources_en_us_standard.js
...
Roblox.Lang["Feature.Home"] = {
  ...
  LuaSubtitle:
    "Explore the basics of Lua and learn how to build Roblox experiences",
  ...
  LuaTitle: "Learn Lua",
  MeggaHuntDescription:
    "The more quests you complete, the more badges you earn for exclusive avatar items. Event ends March 30 at 12 PM PDT.",
  ...
  ResponseErrorOther:
    "System issue. Please try again later, then contact Support.",
...
Roblox.Lang["HomeResources"] = Roblox.Lang["Feature.Home"]; //Bundle detector
