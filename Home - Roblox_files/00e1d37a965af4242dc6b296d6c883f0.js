...
Roblox.Client.LauncherNotCreatedReasons = {
  ...
  wrongInstallHostAndPluginWasNotAllowed:
    "wrongInstallHostAndPluginWasNotAllowed",
...
Roblox.Client.ReleaseLauncher = function (o, removeLock, overrideLocks) {
  ...
  if (Roblox.Client._logTiming) {
    ...
    var ms =
      Roblox.Client._logEndTime.getTime() -
      Roblox.Client._logStartTime.getTime();
  }
};
Roblox.Client.IsUpToDateVersion = function (o) {
  ...
  var installedVersionValues = $.map(
  ...
  var versionStringLength = Math.min(
    serverVersionValues.length,
    installedVersionValues.length,
  );
...
Roblox.Client.GetInstallHost = function (o) {
  if (Roblox.Client.IsIE()) {
    ...
    if (val.match(/roblox.com$/)) return val;
...
Roblox.Client.CreateLauncher = function (addLock) {
  ...
  if (!pluginObj) {
    ...
    if (Roblox.Client.IsIE()) {
      ...
      pluginString +=
        ' id="robloxpluginobj" type="application/x-vnd-roblox-launcher"';
      pluginString +=
        ' codebase="' +
        Roblox.Client._installHost +
        '"><p>Failed to INIT Plugin</p></object>';
      $(pluginDiv).append(pluginString);
    } else {
      pluginString =
        '<object id="robloxpluginobj" type="application/x-vnd-roblox-launcher"><p>Please Install the plugin</p></object>';
      $(pluginDiv).append(pluginString);
    }
  ...
  if (!pluginObj) {
    ...
    Roblox.Client._whyIsRobloxLauncherNotCreated =
      Roblox.Client.LauncherNotCreatedReasons.unknownError;
    return null;
  }
  if ($("#robloxpluginobj p").is(":visible")) {
    Roblox.Client.ReleaseLauncher(pluginObj, addLock, false);
    Roblox.Client._whyIsRobloxLauncherNotCreated =
      Roblox.Client.LauncherNotCreatedReasons.pluginNotInstalled;
    return null;
  }
  try {
    pluginObj.Hello();
  } catch (ex) {
    var browserRequiresPluginActivation =
      Roblox.Client.browserRequiresPluginActivation();
    if (
      browserRequiresPluginActivation &&
      !$("#robloxpluginobj p").is(":visible")
    ) {
      Roblox.Client._whyIsRobloxLauncherNotCreated =
        Roblox.Client.LauncherNotCreatedReasons.pluginNotAllowed;
    } else {
  ...
  try {
    ...
    switch (Roblox.Client._whyIsRobloxLauncherNotCreated) {
      case Roblox.Client.LauncherNotCreatedReasons.pluginNotAllowed:
        ...
        break;
      case Roblox.Client.LauncherNotCreatedReasons
        .wrongInstallHostAndPluginWasNotAllowed:
        break;
      default:
        Roblox.Client._whyIsRobloxLauncherNotCreated =
          Roblox.Client.LauncherNotCreatedReasons.wrongInstallHost;
    }
    Roblox.Client.ReleaseLauncher(pluginObj, addLock, false);
    return null;
  }
  if (!Roblox.Client.IsUpToDateVersion(pluginObj)) {
    Roblox.Client._whyIsRobloxLauncherNotCreated =
      Roblox.Client.LauncherNotCreatedReasons.versionMismatch;
    return null;
  }
  return pluginObj;
};
...
Roblox.Client.WaitForRoblox = function (continuation) {
  ...
  if (Roblox.Client.IsRobloxProxyInstalled()) {
    ...
    GoogleAnalyticsEvents &&
      GoogleAnalyticsEvents.FireEvent(["Plugin", "Activation Begin", osName]);
  } else {
    ...
    GoogleAnalyticsEvents &&
      GoogleAnalyticsEvents.FireEvent(["Plugin", "Install Begin", osName]);
    if (
      Roblox.Client._eventStreamLoggingEnabled &&
    ...
    if (window.chrome || window.safari) {
      ...
      $.cookie(
        ...
        continuation
          .toString()
          .replace(/play_placeId/, play_placeId.toString()),
      );
      if (
        Roblox.Client._eventStreamLoggingEnabled &&
        typeof Roblox.GamePlayEvents != "undefined"
...
Roblox.InstallationInstructions = (function () {
  function show(mode) {
    ...
    if (
      installInstructionsImage &&
      typeof $(installInstructionsImage).data("modalwidth") != "undefined"
    ) {
  ...
  var my = { show: show, hide: hide };
  return my;
})(); //Bundle detector

Roblox &&
  Roblox.BundleDetector &&
  Roblox.BundleDetector.bundleDetected("clientinstaller");
