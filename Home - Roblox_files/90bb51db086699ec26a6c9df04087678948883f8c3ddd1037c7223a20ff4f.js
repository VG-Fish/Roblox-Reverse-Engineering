!(function (r) {
  ...
  11: function (t, e, r) {
    ...
    function p(t, e, r, n, o, i, s) {
      ...
      if (
        0 == u.length &&
        0 == (u = window.performance.getEntriesByName(t + "/")).length
      )
        return a;
      var c = u[u.length - 1];
      return (
        "decodedBodySize" in c &&
          0 < c.decodedBodySize &&
          (a.size = c.decodedBodySize),
        c.duration
          ? (a.d = c.duration)
        ...
        c.requestStart &&
          ...
          0 === c.secureConnectionStart
            ...
            : void 0 !== c.secureConnectionStart &&
              ((a.tls = c.connectEnd - c.secureConnectionStart),
              (a.tcp -= a.tls))),
        a
      );
    }
              ...
              if (200 == t && null != r)
                try {
                  ...
                  for (var i = 0, s = n.targets.length; i < s; i++) {
                    ...
                    if (!f(a.name))
                      throw new Error(
                        o + ".targets[" + i + "].name: not a string",
                      );
                    if (!f(a.target))
                      throw new Error(
                        o + ".targets[" + i + "].target: not a string",
                      );
                  }
                  u(n);
                } catch (t) {
                  return (
                    console && console.error && console.error(t), void u(null)
                  );
                }
              else u(null);
            },
  ...
  26: function (t, e, r) {
    ...
    var a =
      ...
      (u.prototype.run = function () {
        this.recipeProvider.getRecipe(
          this.iteration,
          this.executeTest.bind(this),
        );
      }),
    ...
    var p =
      ((c.prototype.done = function () {
        this.total--,
          0 === this.total && this.cb && (this.cb(), (this.cb = void 0));
      }),
  ...
  43: function (t, e, r) {
    ...
    var n = r(27),
      o =
        ...
        -1 === window.location.hostname.indexOf("test"),
      i = o
