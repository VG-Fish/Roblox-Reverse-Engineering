!(function () {
  var n = {
      ...
      7982: function (t, e, n) {
        var r = { "./directives/templates/alias.html": 9933 };
        function o(t) {
          t = a(t);
          return n(t);
        }
        ...
        function o(c, u, s) {
          ...
          return {
            getContactsMetaData: function () {
              return u
                .httpGet(c.apiSets.getContactsMetadata, {})
                .then(function (t) {
                  return (l = t);
                });
            },
            getUserContacts: function (t, n, e) {
              ...
              return (
                (r = t),
                (o = 2 < arguments.length && void 0 !== e ? e : f.default),
                (a = "aliases"),
                (i = l.multiGetContactsMaxSize),
                (t = l.multiGetContactsCacheTTLinMS),
                (e = c.apiSets.multiGetContacts),
                ((t = s.fetchNonExpiredCachedData(a, t)) &&
                t.data &&
                o === f.default
                  ? Promise.resolve(t.data)
                  : ((i = u.buildBatchPromises(
                      e,
                      r,
                      i,
                      "targetUserIds",
                  ...
                  t &&
                    0 < t.length &&
                    [].concat(p([]), p(t[0])).forEach(function (t) {
  ...
  (o.n = function (t) {
    ...
    (function () {
      ...
      var t = o(5734),
        ...
        n = o(726);
      o(5345),
        (0, n.importFilesUnderPath)(o(1535)),
        (0, n.importFilesUnderPath)(o(6342)),
        (0, n.importFilesUnderPath)(o(2737)),
        (t = o(7982)),
        (0, n.templateCacheGenerator)(e(), "contactsAppTemplates", t);
    })();
})();
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("Contacts");
