!(function () {
  ...
  var n = {
    ...
    d = function () {
      return {
        withCredentials: !0,
        url: ""
          .concat(f, "/v1/behaviors/")
          .concat("user-agreements-policy", "/content"),
      };
    },
    v = function () {
      var e = m();
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 6:
                      (e.prev = 6),
                        (t = T.localStorageService.getLocalStorage(h)),
                        (e.next = 15);
                      break;
                    case 10:
                      if (
                    ...
                    case 24:
                      return (
                        (a = r.getTime()), (e.prev = 25), (e.next = 28), R()
                      );
                    case 28:
                      (o = e.sent),
                        (o = o.data.cooldownPeriodInMs),
                        (e.next = 35);
                      break;
                    case 32:
      ...
      if (r instanceof Date) n.lastFetchTimestamp = r.toISOString();
        ...
        try {
          ...
          if (e instanceof SyntaxError)
            return void T.localStorageService.removeLocalStorage(h);
          throw e;
        }
      try {
  ...
  (e = function (e) {
    ...
    return (
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 14:
                          (t = e.sent),
                            a(t.data),
                            0 < t.data.length
                              ? k.updateDoesUserNeedToAcceptAgreements(!0, n)
                              : k.updateDoesUserNeedToAcceptAgreements(!1, n),
                            (e.next = 22);
                          break;
                        case 19:
                          (e.prev = 19),
      ...
      0 < e.length
        ? i().createElement(D, { translate: r, agreements: e })
        : null
    );
