                            ...
                            : t.pageName === z
                              ? (Le(j.failurePage, { origin: e.origin }),
                                (n = {
                                  ...
                                  icon: "failure-icon",
                                  bodyText: [
                                    t.textKey || "Label.FailedVerification",
                                  ],
                                  errorState: !0,
                                  buttonStack: [
                                    {
                                              ...
                                              buttonStack: [
                                                {
                                                  explicitDisable: !1,
                                                  variant:
                                                    k.Button.variants.secondary,
                                                  text: "Action.SkipVoiceChat",
                                                  callback: function () {
                                                    qe(j.joinWithoutVoiceChat),
                                                      t.close();
                                                  },
                                                },
                                                {
