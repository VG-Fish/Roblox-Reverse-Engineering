!(function () {
  var e = {
      ...
      121: function (e, t, i) {
        var n = { "./abbreviateCountFilter.js": 5033 };
        function a(e) {
          var t = o(e);
          return i(t);
        }
      ...
      5869: function (e, t, i) {
        ...
        function a(e, t, i) {
          return {
            ...
            link: function (e, n, a) {
              t.bind(
                "Roblox.NotificationStream.UnreadNotifications",
                function (t, n) {
                  var a;
                  i.debug(
                    " ----- notificationStreamIconController --- args.count --------".concat(
                      n.count,
                    ),
                  ),
                    e.$evalAsync(
                      ((a = n),
                      (e.layout = e.layout || {}),
                      (e.layout.unreadNotifications = a.count),
                      void (e.layout.isNotificationContentOpen =
                        a.isNotificationContentOpen)),
                    );
                },
              );
            },
        ...
        (a.$inject = ["notificationStreamUtility", "$document", "$log"]),
          n.A.directive("notificationIndicator", a),
          (t.default = a);
      },
      2973: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("a", a),
          (t.default = a);
      },
      8909: function (e, t, i) {
        ...
        function o(e, t, i, a, o) {
          return {
            ...
            link: function (r, c, s) {
              function l(e) {
                (r.layout.unreadNotifications = e.count),
                  (r.layout.isNotificationContentOpen =
                    e.isNotificationContentOpen);
              }
              (r.layout = r.layout || {}),
                (r.getUnreadNotificationCount = function () {
                  a.unreadCount()
                    .then(
                      function (e) {
                        if (e) {
                          ...
                          t > 0 &&
                            o.sendEventWithTarget(
                              o.eventNames.notificationStream.openCTA,
                              o.context.seen,
                              { count: t, sendrVersion: 0 },
                            ),
                ...
                t.bind(
                  "Roblox.NotificationStream.UpdateNotificationsCount",
                  function (e, t) {
                    i.debug(
                      " ----- notificationStreamIconController --- args.count --------".concat(
                        t.count,
                ...
                t.bind(
                  ...
                  function () {
                    r.layout.unreadNotifications > 0 &&
                      (l({ count: 0, isNotificationContentOpen: !0 }),
                ...
                (r.initializeRealTimeSubscriptions = function () {
                  angular.isDefined(n.RealTime) &&
                    n.RealTime.Factory.GetClient().Subscribe(
                      e.notificationsName.NotificationStream,
                      r.getUnreadNotificationCount,
                    );
                }),
                (r.layout && r.layout.isNotificationContentOpen) ||
                  (r.getUnreadNotificationCount(),
                  r.initializeRealTimeSubscriptions());
                  ...
                  e.forEach(function (e) {
                    ...
                    null !== (t = e.active) &&
                      ...
                      "/service-workers/push-notifications" ===
                        new URL(e.active.scriptURL).pathname &&
                      e.unregister();
                  });
                });
            },
        ...
        (o.$inject = [
          ...
          a.A.directive("notificationStreamIndicator", o),
          (t.default = o);
      },
      5033: function (e, t, i) {
        "use strict";
          ...
          a = {
            endpoints: {
              getReadEndpoint: function () {
                return {
                  url: "".concat(
                    n.EnvironmentUrls.notificationApi,
              ...
              getGameFollowingsEndpoint: function (e) {
                return {
                  url: ""
                    .concat(n.EnvironmentUrls.followingsApi, "/v1/users/")
                    .concat(e, "/universes"),
                  retryable: !0,
                  withCredentials: !0,
                };
              ...
              getAbuseReportUrl: function (e, t, i) {
                return ""
                  .concat(
                    n.EnvironmentUrls.websiteUrl,
                    "/abusereport/gameupdate?id=",
                  )
                  .concat(e, "&redirectUrl=")
                  .concat(i);
              },
            },
            apiParams: { gameUpdateBatchSize: 100, placeDetailBatchSize: 100 },
      ...
      9584: function (e, t, i) {
        ...
        function g(e, t, i, a, c, l, u, f, p, g, v, y) {
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (e.next = 3),
                          r.cryptoUtil.hashStringWithSha256(
                            "".concat(JSON.stringify(o)).concat(Date.now()),
                          )
                        );
                      case 3:
                        return (
                          (c = e.sent),
                          u.sendEventWithTarget(
                            u.eventNames.notificationStream
                              .notificationsBundleCreated,
                            u.context.fetched,
                            d(
                              d(
                                {},
          ...
          (e.buildNotificationsList = function (t) {
            ...
            t.forEach(function (t) {
              ...
              if (
                (null !== (a = t.content) &&
                  void 0 !== a &&
                  a.notificationType &&
                  ((f = t.content.notificationType),
                  (p = t.content.minVersion.toString())),
                u.sendEventWithTarget(
                  u.eventNames.notificationStream.notificationRetrieved,
                  u.context.fetched,
                  d(
                    d(
                      {},
                      null == t || null === (o = t.content) || void 0 === o
                        ? void 0
                        : o.clientEventsPayload,
                    ),
                    {},
                    {
                      sendrVersion: p,
                ...
                c.isGameUpdateNotification(l) ||
                  c.isReactNotification(l) ||
                  s.forEach(function (t) {
                    ...
                    if (n && null != n.userId && null != n.userName) {
                      ...
                      i.push(a),
                        e.library.userIdList.push(a),
                        (e.library.userLibrary[a] = {
                          id: a,
                          name: o,
                  ...
                  (t.isClickable = c.isCardClickable(t)),
                  e.notificationIds.indexOf(t.id) < 0 &&
                    e.notificationIds.push(t.id);
                var m =
              ...
              (e.layout.emptyNotificationEnabled =
                0 === e.notificationIds.length);
          }),
            (e.buildGameUpdateNotifications = function (t) {
              if (t && 0 !== t.length) {
                var i = e.library.gameUpdateModels;
                f.getGameFollowingsForUserAsync(e.library.currentUserId)
                  .then(function (e) {
                    var t,
                      n = [];
                  ...
                  .then(function (n) {
                    var a,
                      o = p.aggregateGameUpdateNotifications(t, i);
                    if (o) {
                      (e.notifications[o.id] = o),
                        e.notificationIds.unshift(o.id),
                        p.fillGameDetails(i),
                        1 === o.metadataCollection.length &&
                          ((a = i[o.metadataCollection[0].UniverseId]),
                          f.markGameUpdateInteractedAsync(
                            a.universeId,
                            a.createdOnKey,
                            g.gameUpdateInteractions.seen,
                            e.library.currentUserId,
                          ));
                      for (
                        var r = p.sortGameUpdatesByCreatedDate(i, !1),
                          c = b(new Date().toUTCString()),
                          s = 0,
                          d = 0;
                        d < r.length;
                        d++
                      ...
                      u.sendEventWithTarget(
                        l.recentGameUpdateRetrievedEventName,
                        u.context.fetched,
                        {
                          sendrVersion: "0",
            ...
            (e.getRecentNotifications = function () {
              (e.layout.getRecentDataInitialized = !1),
                a
                  .getRecentNotifications(
                    e.notificationApiParams.startIndexOfNotifications,
                    e.notificationApiParams.pageSizeOfNotifications,
                  )
                  .then(
                    function (t) {
                      var i = [],
                        n = [];
                      (e.layout.getRecentDataInitialized = !0),
                        (e.layout.isGetRecentDataLoadedRequested = !1),
                        t &&
                          t.length > 0 &&
                          (o().forEach(t, function (e) {
                            c.isGameUpdateNotification(e.notificationSourceType)
                              ? i.push(e)
                              : n.push(e);
                          }),
                          e.buildNotificationsList(n),
                          i.length > 0 && e.buildGameUpdateNotifications(i),
                          (e.layout.isLazyLoadingRequested = !0),
                          t.length > 0 &&
                            ((e.notificationApiParams.startIndexOfNotifications =
                              e.notificationApiParams
                                .startIndexOfNotifications +
                              e.notificationApiParams.pageSizeOfNotifications),
                            (e.notificationApiParams.loadMoreNotifications =
                              !0)));
                    },
                    function () {
                      v.debug("--- getRecentNotifications call failed ----- "),
                        (e.layout.getRecentDataInitialized = !0);
                    },
                  );
            }),
            (e.setNotificationContentOpen = function (t) {
              ((e.layout.isNotificationContentOpen = t), t) ||
                (window.removeEventListener(
                  "Roblox.NotificationStream.StreamClosed",
                  e.handleStreamClosed,
                ),
                n.RealTime.Factory.GetClient().Unsubscribe(
                  c.notificationsName.NotificationStream,
                  e.handleNotificationStreamNotification,
                ));
            }),
                ...
                t.triggerHandler(
                  "Roblox.NotificationStream.UpdateNotificationsCount",
                  {
                    ...
                    isNotificationContentOpen:
                      e.layout.isNotificationContentOpen,
                  },
                ));
            }),
            (e.openNotificationStream = function () {
              e.layout.isGetRecentDataLoadedRequested &&
                (e.resetNotificationStreamData(), e.getRecentNotifications()),
                t.triggerHandler(
                  "Roblox.NotificationStream.ClearUnreadNotifications",
                  {},
                ),
            ...
            (e.toggleNotificationContent = function (t) {
              t
                ...
                : (e.library.inApp ||
                    e.setNotificationContentOpen(
                      !e.layout.isNotificationContentOpen,
                    ),
                  e.layout.isNotificationContentOpen &&
                    e.layout.isGetRecentDataLoadedRequested &&
                    e.openNotificationStream()),
                e.layout.isNotificationContentOpen &&
                  e.layout.bannerEnabled &&
                  (e.layout.bannerEnabled = !1),
                e.layout.isLazyLoadingRequested &&
                  (e.layout.isLazyLoadingRequested = !1);
            }),
            (e.getUnreadNotificationCount = function () {
              return a.unreadCount().then(
                function (i) {
                  if (i) {
                    e.library.unreadNotifications = i.unreadNotifications;
                    var n,
                      a = i.unreadNotifications,
                      o = e.layout.isNotificationContentOpen;
                    if (
                      (o
                        ? (e.layout.bannerText = c.textTemplate.newNotification(
                            e.library.unreadNotifications,
                          ))
                        : t.triggerHandler(
                            "Roblox.NotificationStream.UpdateNotifications",
                            {
                              count: i.unreadNotifications,
                              isNotificationContentOpen: o,
                            },
                          ),
                      e.layout.unreadNotifications !== a && a > 0)
                    )
                      (n = o
                        ? u.eventNames.notificationStream.refreshCTA
                        : u.eventNames.notificationStream.openCTA),
                        u.sendEventWithTarget(n, u.context.seen, {
                          count: a,
                          sendrVersion: 0,
                        });
                  }
            ...
            (e.resetNotificationStreamData = function () {
              (e.notificationIds = []),
                (e.notifications = {}),
                e.notificationApiParams &&
                  (e.notificationApiParams.startIndexOfNotifications = 0);
            }),
            (e.reloadNotificationStreamData = function () {
              e.resetNotificationStreamData(),
                t.triggerHandler(
                  "Roblox.NotificationStream.ClearUnreadNotifications",
                  {},
                ),
                e.getRecentNotifications(),
                (e.layout.bannerEnabled = !1);
            }),
            (e.updateNewNotificationInfo = function () {
              (e.layout.isGetRecentDataLoadedRequested = !0),
                e.getUnreadNotificationCount(),
                e.$evalAsync(function () {
                  e.layout.isNotificationContentOpen &&
                    (e.layout.bannerEnabled = !0);
                });
            }),
            (e.updateSettingsInLibrary = function (t) {
              (e.library.bannerDismissTimeSpan = t.bannerDismissTimeSpan),
                (e.library.signalRDisconnectionResponseInMilliseconds =
                  t.signalRDisconnectionResponseInMilliseconds),
                (e.library.eventStreamMetaData = {
                  userId: e.library.currentUserId,
                  inApp: e.library.inApp,
                }),
                (e.library.canLaunchGameFromGameUpdate =
                  t.canLaunchGameFromGameUpdate);
            }),
            ...
            (e.handleSignalRError = function () {
              i(function () {
                (e.layout.errorBannerEnabled = !0),
                  (e.layout.errorText =
                    c.textTemplate.noNetworkConnectionText());
              }, e.library.signalRDisconnectionResponseInMilliseconds);
            }),
            (e.handleNotificationStreamNotification = function (t) {
              switch (
                (v.debug(
                  "--------- this is NotificationStream subscription -----------".concat(
                    t.Type,
                  ),
                ),
                t.Type)
                ...
                case c.signalRType.NotificationRevoked:
                  e.getUnreadNotificationCount(),
                    e.layout.isStreamBodyInteracted ||
                      e.reloadNotificationStreamData();
              }
            }),
            (e.getAccountSettingsPolicy = function () {
              a.getAccountSettingsPolicy().then(
                function (t) {
                  e.library.isNotificationPreferencesPageEnabled =
                    t && t.displayReactNotificationsTab;
                },
                function (e) {
                  v.debug(e);
                },
            ...
            (e.getNotificationListItemClass = function (e) {
              return c.isReactNotification(e.notificationSourceType)
                ...
                : {
                    ...
                    "game-update": c.isGameUpdateNotification(
                      e.notificationSourceType,
                    ),
                  };
            }),
            (e.initializeRealTimeSubscriptions = function () {
              if (o().isDefined(n.RealTime)) {
                ...
                t.SubscribeToConnectionEvents(
                  e.handleSignalRSuccess,
                  e.handleSignalRSuccess,
                  e.handleSignalRError,
                  c.notificationsName.NotificationStream,
                ),
                  t.Subscribe(
                    c.notificationsName.NotificationStream,
            ...
            (e.getUnreadNotificationCountFromDom = function () {
              ...
              t &&
                !Number.isNaN(t) &&
                (e.library.unreadNotifications = parseInt(t.html(), 10));
            }),
            ...
            (e.initializeNotificationStream = function () {
              !(function () {
                try {
                  (e.library = e.library || c.library),
                    e.resetNotificationStreamData(),
                    e.getAccountSettingsPolicy(),
                    a.initialize().then(
                      function (t) {
                        t &&
                          ((c.layout.pageDataInitialized = !0),
                          e.updateSettingsInLibrary(t));
                      },
                      function () {
                ...
                (function () {
                  if (
                    ((e.layout = o().copy(c.layout)),
                    (e.notificationApiParams = o().copy(
                      c.notificationApiParams,
                    )),
                    e.library.inApp)
                  ) {
                    var t = o().copy(e.library.eventStreamMetaData);
                    (t.countOfUnreadNotification =
                      e.library.unreadNotifications),
                      (t.sendrVersion = 0),
                      u.sendEventWithTarget(
                        u.eventNames.notificationStream.openContent,
                        u.context.inApp,
                        t,
                      ),
                      e.getUnreadNotificationCount().then(function () {
                        a.clearUnread().then(function () {
                          e.library.unreadNotifications = 0;
                        });
                      }),
                ...
                e.initializeRealTimeSubscriptions(),
        ...
        (g.$inject = [
          ...
          c.A.controller("notificationStreamController", g);
        var v = g;
      },
      5364: function (e, t, i) {
        "use strict";
        ...
        function l(e, t, i, n, o, r, s, l, u, d) {
          function f(t, i, n) {
            ...
            (l.notificationId = i),
              (l.sendrVersion = 0),
              s && (l.notificationType = s.notificationSourceType);
            var u = c(c({}, l), o);
          ...
          (e.parseErrorFromApiResponse = function (e) {
            ...
            (e.acceptFriend = function (i, n, a) {
              ...
              e.interactNotification(o),
                t.acceptFriendV2(i).then(
                  function (t) {
                  ...
                  function (t) {
                    ...
                    i &&
                      i.userFacingMessage &&
                      ((e.layout.errorText = i.userFacingMessage),
                      (e.layout.errorBannerEnabled = !0));
                  },
                );
            }),
            (e.onAcceptFriendSuccess = function (t, n) {
              ...
              (a.friendRequestActionType = i.friendRequestActionType.chatBtn),
                (a.metadataCollection[0].IsAccepted = !0),
                (a.isFlipped = !0),
                u.triggerHandler("Roblox.Friends.CountChanged"),
                f(
                  r.eventNames.notificationStream.acceptFriendRequest,
                  t,
                  n.type,
                );
            }),
            ...
            (e.onIgnoreFriend = function (t, i) {
              (e.notifications[t].isSlideOut = !0),
                f(
                  r.eventNames.notificationStream.ignoreFriendRequest,
                  t,
                  i.type,
                );
            }),
            (e.removeNotification = function (t) {
              d.debug(
                "---------------- removeNotification --------- notificationId:  ".concat(
                  t,
                ),
              );
            ...
            (e.chat = function (t, i, n) {
              ...
              (o.uwpApp.hybridRequired = !0),
                l.startChat(t, o),
                f(r.eventNames.notificationStream.chat, i, n.type);
            }),
            (e.interactNotification = function (e) {
              e.isInteracted ||
                t.markInteracted(e.id).then(function () {
                  e.isInteracted = !0;
                });
            }),
              ...
              switch (t.notificationSourceType) {
                case i.notificationSourceType.friendRequestReceived:
                  if (
                    ...
                    t.eventCount > 1 || 0 === t.metadataCollection.length)
                  )
                    (l = i.links.friendRequestLink),
                      e.library.inApp
                        ? ((u = {
                ...
                case i.notificationSourceType.friendRequestAccepted:
                  ...
                  f(n.acceptFriendGroupCount, t.id, t.notificationSourceType, {
                    ...
                    e.library.inApp
                      ? ((u = { feature: i.links.friendsTabName, urlPath: l }),
                        o.navigateToFeature(u, function (e) {
                ...
                case i.notificationSourceType.privateMessageReceived:
                  if (
                    ...
                    l =
                      i.links.inboxLink +
                      i.links.inboxMessageDetailQuery +
                      p.MessageId;
                  }
                  f(
                    r.eventNames.notificationStream.goToMessages,
                    t.id,
                    t.notificationSourceType,
                    { targetUrl: l },
                  ),
                    e.library.inApp
                      ? ((u = { feature: i.links.inboxTabName, urlPath: l }),
                        o.navigateToFeature(u, function (e) {
                          d.debug("openUserProfile ---- status:".concat(e));
                        }))
                      : (window.location.href = s.getAbsoluteUrl(l));
                ...
                case i.notificationSourceType.groupJoinRequestAccepted:
                  if (
                    (e.interactNotification(t),
                    0 === t.metadataCollection.length)
                  )
                    (l = i.links.myGroupsLink),
                      f(
                        r.eventNames.notificationStream.goToGroupPage,
                        t.id,
                        t.notificationSourceType,
                        { groupId: 0 },
                      ),
                      e.library.inApp
                        ? ((u = { feature: i.links.groupsTabName, urlPath: l }),
                          o.navigateToFeature(u, function (e) {
            ...
            (e.notificationSourceType = i.notificationSourceType),
            (e.contentViewManager =
              ((p = {}),
              {
                ...
                selectContentView: function (e) {
                  var t,
                    i =
                      null !== (t = this.getCurrentContentViewId) &&
                      void 0 !== t
                        ? t
                        : "",
                    n = p[e];
                  n &&
                    ...
                    "" !== i &&
                      ...
                      r.sendEventWithTarget(
                        r.eventNames.notificationStream.pageChanged,
                        r.context.click,
                        { targetPage: e, sendrVersion: 0 },
                      ));
                },
                getCurrentContentViewId: function () {
                  var e = "";
                  return (
                    a().forEach(p, function (t, i) {
                      t.isActive && (e = i);
                    }),
                    e
                  );
            ...
            u.bind("Roblox.Popover.Status", function (t, i) {
              d.debug("notificationsController"),
                i.isOpen ||
                  e.contentViewManager.selectContentView(
                    e.library.notificationContentViews.main,
                  );
            });
        }
        (l.$inject = [
          ...
          o.A.controller("notificationsController", l),
          (t.default = l);
      },
      2315: function (e, t, i) {
        "use strict";
              ...
              c.bind("click", function (s) {
                ...
                if (
                  (null !== p &&
                    r.notification &&
                    ((d.notificationType =
                      r.notification.notificationSourceType),
                    (d.notificationId = r.notification.id),
                    e.sendEventWithTarget(p, e.context.click, d)),
                  s.target &&
                    u &&
                    (r.notification &&
                      ((d.notificationType =
                        r.notification.notificationSourceType),
                      r.interactNotification(r.notification)),
                    (p = e.eventNames.notificationStream[u]),
                    e.sendEventWithTarget(p, s.type, d),
                    r.library.inApp))
                ) {
                  switch ((s.stopPropagation(), s.preventDefault(), u)) {
                    ...
                    case i.links.profileLinkName:
                      ...
                      (g =
                        l.attr("href") &&
                        l.attr("href").match(/users\/(\d+)/, "")
                          ? l.attr("href").match(/users\/(\d+)/, "")[1]
                          : r.userIds[0]),
                        t.openUserProfile(parseInt(g), function (e) {
                          n.debug("openUserProfile ---- status:".concat(e));
                        });
                      break;
                    case i.links.groupLinkName:
                      ...
                      if (
                        l.attr("href") &&
                        l.attr("href").match(/groups\/(\d+)/, "")
                      ) {
                        var y = l.attr("href").match(/groups\/(\d+)/, "")[1];
                        v = o("formatString")(i.links.groupLink, { id: y });
                      } else v = i.links.myGroupsLink;
                      (m = { feature: i.links.groupsTabName, urlPath: v }),
                        t.navigateToFeature(m, function (e) {
      ...
      6690: function (e, t, i) {
        ...
        function o(e, t, i, a) {
          return {
            ...
            link: function (o, r, c) {
              !(function () {
                (o.notificationSourceType = t.notificationSourceType),
                  (o.developerMetricsAvailableLayout = {
                    month: "",
                    year: "",
                    universeId: -1,
                    gameName: "",
                ...
                if (r && r.length > 0) {
                  var c = r[0],
                    s = i.getAbsoluteUrl(
                      "/places/".concat(c.rootPlaceId, "/stats"),
                    );
                  (o.developerMetricsAvailableLayout.month = (function (e) {
                    for (
                      var t = new n.Intl().getMonthsList("long"),
                        i = 0,
                        a = t.length;
                      i < a;
                      i++
                    ...
                    (o.developerMetricsAvailableLayout.year = c.year),
                    (o.developerMetricsAvailableLayout.universeId =
                      c.universeId),
                    (o.developerMetricsAvailableLayout.gameName = c.gameName),
                    (o.developerMetricsAvailableLayout.gameNameLinked =
                      '<a class="text-name font-caption-header" href="'
                        .concat(s, '">')
                        .concat(c.gameName, "</a>")),
                    (o.developerMetricsAvailableLayout.rootPlaceId =
                      c.rootPlaceId),
                    (o.developerMetricsAvailableLayout.gameLinkUrl = s),
                    (o.developerMetricsAvailableLayout.notificationId =
                      o.notification.id),
                    (o.viewButtonHandler = function () {
                      e.location.href =
                        o.developerMetricsAvailableLayout.gameLinkUrl;
                      var i =
                          a.eventNames.notificationStream.viewDeveloperMetrics,
                        n = {
                          notificationId:
                            o.developerMetricsAvailableLayout.notificationId,
                          notificationType:
                            t.notificationSourceType.developerMetricsAvailable,
                          universeId:
                            o.developerMetricsAvailableLayout.universeId,
                          sendrVersion: 0,
                        };
        ...
        (o.$inject = [
          ...
          a.A.directive("developerMetricsAvailable", o),
          (t.default = o);
      },
      2343: function (e, t, i) {
        "use strict";
          ...
          return {
            ...
            link: function (t, n, a) {
              var o = t.notification.metadataCollection,
                ...
                l = "",
                u = "";
              (t.notificationSourceType = e.notificationSourceType),
                (t.friendRequestLink = e.layout.friendRequestLink),
                (t.thumbnailTypes = i.thumbnailTypes),
                (function () {
                  if (
                    ((t.userIds = []),
                    (t.notificationDisplayText = ""),
                    o.forEach(function (i, n) {
                      var a = e.normalizeUser(r, i),
                        ...
                        d = a.displayName,
                        f =
                          t.library.userLibrary[o] &&
                          t.library.userLibrary[o].profileLink
                            ? t.library.userLibrary[o].profileLink
                            : e.getAbsoluteUrl(e.links.profileLink, { id: o });
                    ...
                    t.notificationDisplayText = e.normalizeYouHaveText(r, s);
                  else if (s > 2 || s > c) {
                    var i = c > 2 ? s - 2 : s - c;
                    (t.notificationDisplayText = e.normalizeMultipleDisplayText(
                      r,
                      l,
                      u,
                      i,
                    )),
                      (t.requestConfirmedText =
                        e.normalizeMultipleConfirmedText(r, l, u, i));
                  } else
                    2 === s
                      ? ((t.notificationDisplayText =
                          e.normalizeDoubleDisplayText(r, l, u)),
                        (t.requestConfirmedText =
                          e.normalizeDoubleConfirmedText(r, l, u)))
                      : ((t.notificationDisplayText =
                          e.normalizeSingleDisplayText(r, l)),
                        (t.requestConfirmedText =
                          e.normalizeSingleConfirmedText(r, l)));
                })(),
                (t.friendRequestActionType = e.friendRequestActionType),
                t.notification.notificationSourceType ===
                e.notificationSourceType.friendRequestReceived
                  ? 1 !== c || 1 !== s || o[0].IsAccepted
                    ? 1 === c && 1 === s && o[0].IsAccepted
                      ? (t.notification.friendRequestActionType =
                          e.friendRequestActionType.chatBtn)
                      : (t.notification.friendRequestActionType =
                          e.friendRequestActionType.viewAllBtn)
                    : (t.notification.friendRequestActionType = o[0].IsAccepted
                        ? e.friendRequestActionType.chatBtn
                        : e.friendRequestActionType.acceptIgnoreBtns)
                  : t.notification.notificationSourceType ===
                      e.notificationSourceType.friendRequestAccepted &&
                    1 === c &&
                    1 === s &&
                    (t.notification.friendRequestActionType =
                      e.friendRequestActionType.chatBtn);
        ...
        function c(e, t, i, a, r, c, s, l, u, d) {
          ...
          return {
            ...
            templateUrl: function (e, t) {
              return void 0 === t.newDesign || null === t.newDesign
                ? r.templates.gameUpdateTemplate
                : r.templates.newGameUpdateTemplate;
            },
            scope: {
              library: "=",
              appMeta: "=",
            ...
            link: function (a, s, p) {
              ...
              if (!a.gameUpdateModel) {
                ...
                if (
                  ((m = a.notification.metadataCollection) &&
                    m.length > 0 &&
                    (a.gameUpdateModel =
                      a.library.gameUpdateModels[m[0].UniverseId]),
                  !a.gameUpdateModel)
                )
                  return;
              }
              var v = ""
                .concat(a.gameUpdateModel.rootPlaceId, "-")
                .concat(a.gameUpdateModel.createdOn);
              (a.notificationSourceType = r.notificationSourceType),
                (a.thumbnailTypes = u.thumbnailTypes),
                m &&
                  m.length > 1 &&
                  ((a.isAggregated = !0),
                  (a.aggregatedDisplayText = i.formatAggregatedDisplayText(
                    l("escapeHtml")(m[0].GameName),
                    l("escapeHtml")(m[1].GameName),
                    a.notification.eventCount - 2,
                  ))),
                (a.gameNameMaxLength = i.gameNameMaxLength),
                (a.actionMenuTemplate = "game-update-action-popover-template"),
                (a.isActionMenuOpen = !1),
                (a.getEventExtraParams = function () {
                  var e;
                  return {
                    notifId: v,
                    ...
                    isAggregate:
                      null !== (e = a.isAggregated) && void 0 !== e && e,
                ...
                (a.goToGameDetails = function () {
                  d.sendEventWithTarget(
                    d.eventNames.notificationStream.goToGameDetails,
                    d.context.click,
                    a.getEventExtraParams(),
                  ),
                    a.library.inApp
                      ...
                      : (e.location.href = urlService.getAbsoluteUrl(
                          a.gameUpdateModel.gameLinkUrl,
                        ));
                }),
                (a.playButtonHandler = function () {
                  t.markGameUpdateInteractedAsync(
                    a.gameUpdateModel.universeId,
                    a.gameUpdateModel.createdOnKey,
                    f.played,
                    ...
                    a.library.inApp
                      ...
                      : n.GameLauncher.joinMultiplayerGame(
                          a.gameUpdateModel.rootPlaceId,
                          !0,
                          !1,
                        ),
                    d.sendEventWithTarget(
                      d.eventNames.notificationStream.launchExperience,
                      d.context.click,
                      a.getEventExtraParams(),
                    );
                }),
                (a.viewGameUpdates = function () {
                  a.contentViewManager.selectContentView(
                    a.library.notificationContentViews.gameUpdates,
                  ),
                    o().forEach(a.library.gameUpdateModels, function (e) {
                      e.seen ||
                        t
                ...
                (a.followGame = function () {
                  d.sendEventWithTarget(
                    d.eventNames.notificationStream.follow,
                    d.context.click,
                    a.getEventExtraParams(),
                  ),
                    t
                      ...
                      .then(
                        function () {
                          g.focus(),
                            (a.gameUpdateModel.isUnfollowed = !1),
                            a.gameUpdateModel.updateMessage ||
                              i.getGameUpdatesAsync(
                                [a.gameUpdateModel.universeId],
                                a.library.gameUpdateModels,
                                null,
                              );
                        },
                        function () {},
                ...
                (a.unfollowGame = function (e) {
                  e && e.stopPropagation && e.stopPropagation(),
                    d.sendEventWithTarget(
                      d.eventNames.notificationStream.unfollow,
                      d.context.click,
                      a.getEventExtraParams(),
                    ),
                    t
                      ...
                      .then(
                        function () {
                          g.focus(),
                            (a.gameUpdateModel.isUnfollowed = !0),
                            (a.isActionMenuOpen = !1),
                            t.markGameUpdateInteractedAsync(
                              a.gameUpdateModel.universeId,
                              a.gameUpdateModel.createdOnKey,
                ...
                (a.reportAbuse = function () {
                  t.reportAbuse(
                    a.gameUpdateModel.universeId,
                    new Date(a.gameUpdateModel.createdOn),
                  ),
                    d.sendEventWithTarget(
                      d.eventNames.notificationStream.report,
                      d.context.click,
                      a.getEventExtraParams(),
                    );
                }),
      ...
      1625: function (e, t, i) {
                  ...
                  if (
                    ...
                    r.forEach(function (i, a) {
                      var o = i.AccepterGroupId,
                        ...
                        c = e.getAbsoluteUrl(e.layout.groupLink, { id: o }),
                    ...
                    t.notificationDisplayText = e.normalizeYouHaveText(c, l);
                  else if (l > 2 || l > s) {
                    var i = s > 2 ? l - 2 : l - s;
                    t.notificationDisplayText = e.normalizeMultipleDisplayText(
                      c,
                    ...
                    t.notificationDisplayText =
                      2 === l
                        ? e.normalizeDoubleDisplayText(c, u, d)
                        : e.normalizeSingleDisplayText(c, u);
                })();
            },
          };
        }
        (a.$inject = [
          ...
          n.A.directive("groupMembership", a),
          (t.default = a);
      },
      7250: function (e, t, i) {
        "use strict";
          ...
          return {
            ...
            link: function (t, n, o) {
              (t.callbackLazyLoad = function () {
                if (!t.notificationApiParams || t.layout.isNotificationsLoading)
                  return !1;
                t.notificationApiParams.loadMoreNotifications &&
                  ((t.layout.isNotificationsLoading = !0),
                  (t.layout.notiticationsLazyLoadingEnabled = !0),
                  e
                    .getRecentNotifications(
                      t.notificationApiParams.startIndexOfNotifications,
                      t.notificationApiParams.pageSizeOfNotifications,
                    )
                    .then(
                      function (e) {
                        (t.layout.notiticationsLazyLoadingEnabled = !1),
                          e && e.length > 0
                            ? (t.buildNotificationsList(e),
                              (t.notificationApiParams.startIndexOfNotifications =
                                t.notificationApiParams
                                  .startIndexOfNotifications +
                                t.notificationApiParams
                                  .pageSizeOfNotifications))
                            : ((t.notificationApiParams.loadMoreNotifications =
                                !1),
                              (t.notificationApiParams.startIndexOfNotifications = 0)),
                          (t.layout.isNotificationsLoading = !1);
                      },
                      function () {
                        (t.layout.notiticationsLazyLoadingEnabled = !1),
                          i.debug(
                            "---error from get Notificaitons in lazyLoadingDirective.js---",
                          ),
                          (t.layout.isNotificationsLoading = !1);
                      },
                    ));
              ...
              var r = t.$watch(
                ...
                function (e, n) {
                  a().isDefined(e) &&
                    e !== n &&
                    (i.debug("----- initializeLayout ----"),
                    e ? t.setupScrollbar() : t.destroyScrollbar());
                },
                !0,
              );
        ...
        (r.$inject = ["notificationStreamService", "$document", "$log"]),
          o.A.directive("lazyLoading", r),
          (t.default = r);
      },
      2735: function (e, t, i) {
        "use strict";
        ...
        function r(e, t) {
          var i = {
            ...
            n = (function () {
              var e,
                t = document.createElement("supportedEvent");
              for (e in i) if (a().isDefined(t.style[e])) return i[e];
            })();
          return {
            restrict: "A",
            link: function (i, a, o) {
              a.bind(n, function (t) {
                e.debug("got a css transition event", t),
                  t.target.className.search("slide-out-left") >= 0 &&
                ...
                (i.updateNotificationSetting = function (n) {
                  t.updateNotificationSettings(
                    i.notification.notificationSourceType,
                    n,
                  ).then(
                    function (t) {
                      e.debug("turnOffNotification -- success", t),
                        (i.notification.isTurnOff = !n);
                    },
                    function (t) {
        ...
        (r.$inject = ["$log", "notificationStreamService"]),
          o.A.directive("notificationCard", r),
          (t.default = r);
      },
      1568: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("notificationContent", a),
          (t.default = a);
      },
      6339: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("notificationContentView", a),
          (t.default = a);
      },
      4274: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("notificationStreamBase", a),
          (t.default = a);
      },
      2389: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("notificationStreamBaseView", a),
          (t.default = a);
      },
      1209: function (e, t, i) {
        "use strict";
          ...
          return {
            ...
            link: function (i, n, a) {
              e.on("click touchstart", function (e) {
                i.layout &&
                  (!i.layout.isStreamBodyInteracted &&
                  n.has(e.target).length > 0
                    ? (i.layout.isStreamBodyInteracted = !0)
                    : i.layout.isStreamBodyInteracted &&
                      !n.has(e.target).length > 0 &&
                      (i.layout.isStreamBodyInteracted = !1),
                  t.debug(
                    " ------------------scope.layout.isStreamBodyInteracted----------------- " +
                      i.layout.isStreamBodyInteracted,
                  ));
              });
            },
        ...
        (a.$inject = ["$document", "$log"]),
          n.A.directive("notificationStreamBody", a),
          (t.default = a);
      },
      3010: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility", "$log"]),
          n.A.directive("notificationStreamContainer", a),
          (t.default = a);
      },
      2350: function (e, t, i) {
        "use strict";
          ...
          return {
            ...
            link: function (t, a, o) {
              !(function () {
                ...
                if (
                  ((t.notification.eventCount > 1 || (a && 0 === a.length)) &&
                    (t.privateMessageLayout.isStacked = !0),
                  a && a.length > 0)
                ) {
                  var r = e.normalizeUser(o, a[0]);
                  (t.privateMessageLayout.displayUserId = r.userId),
                    (t.privateMessageLayout.displayUserName =
                      n.DisplayNames && n.DisplayNames.Enabled()
                        ? r.displayName
                        : r.userName),
                    (t.privateMessageLayout.messagePreview = a[0].BodyPreview);
                }
              })();
            },
          };
        ...
        (o.$inject = [
          ...
          a.A.directive("privateMessage", o),
          (t.default = o);
      },
      9604: function (e, t, i) {
        "use strict";
        ...
        function a() {
          return {
            ...
            link: function (e, t) {
              t.ready(function () {
                null === n.NotificationStreamService ||
                  void 0 === n.NotificationStreamService ||
                  n.NotificationStreamService.renderSendrModalContainer(t[0]);
              });
            },
          };
        }
          ...
          return {
            ...
            link: function (e, t) {
              t.ready(function () {
                null === n.NotificationStreamService ||
                  void 0 === n.NotificationStreamService ||
                  n.NotificationStreamService.renderSendrNotification(t[0]);
              });
            },
          };
        }
      ...
      604: function (e, t, i) {
        ...
        (a.$inject = ["gameUpdatesUtility"]),
          n.A.filter("sortGameUpdates", a),
          (t.default = a);
      },
      2950: function (e, t, i) {
        "use strict";
        ...
        (a.$inject = ["notificationStreamUtility"]),
          n.A.filter("sortNotificationsByEventDateDesc", a),
          (t.default = a);
      },
      9595: function (e, t, i) {
        "use strict";
        var n = i(7577),
          ...
          o = i
            ...
            .config([
              ...
              function (e) {
                var t =
                  new n.TranslationResourceProvider().getTranslationResource(
      ...
      8896: function (e, t, i) {
        ...
        function c(e, t, i, a, r, c) {
          ...
          function u(i, n, a, o) {
            var r,
              ...
              s = [],
              l = 0;
            for (c = n.slice(l, a); c.length > 0 && l < n.length; )
              (r = o(c)),
                s.push(e.httpGet(i, r)),
                (l += a),
                (c = n.slice(l, l + a));
            return t.all(s);
          }
          return {
            ...
            multiGetPlaceDetailsAsync: function (e) {
              return e && 0 !== e.length
                ? (function (e) {
                    return u(
                      s.getGameDetailsEndpoint(),
                      e,
                      l.placeDetailBatchSize,
                      function (e) {
                        return { placeIds: e };
                      },
                    ).then(function (e) {
            ...
            multiGetGameUpdatesAsync: function (e, i) {
              return e && 0 !== e.length
                ? (function (e) {
                    return u(
                      s.getGameUpdatesEndpoint(),
                      e,
                      l.gameUpdateBatchSize,
                      function (e) {
                        return { universeIds: e };
                      },
                    ).then(function (e) {
                      var t = [];
                      return e && 0 !== e.length
            ...
            reportAbuse: function (e, t) {
              var i = a.getAbsoluteUrl(
                s.getAbuseReportUrl(e, t, encodeURIComponent(c.location.href)),
              );
              n.AbuseReportDispatcher
                ? n.AbuseReportDispatcher.triggerUrlAction(i)
                : (c.location.href = i);
            },
          };
        }
        (c.$inject = [
          ...
          r.A.factory("gameUpdatesService", c),
          (t.default = c);
      },
      6007: function (e, t, i) {
        "use strict";
        ...
        function r(e, t, i, n, o, r) {
          ...
          return {
            formatAggregatedDisplayText: function (e, t, i) {
              return 0 === i
                ? o.gameUpdates.formatDisplayTextDouble(e, t)
                : o.gameUpdates.formatDisplayTextMultiple(e, t, i);
            },
            getGameUpdatesAsync: function (i, n, a) {
              return e
                .multiGetGameUpdatesAsync(
                  i,
                  a ? new Date(a.getTime() - 6e4) : null,
                )
                .then(function (e) {
                  var i, a, o, r, l, u;
                  ...
                  for (i = 0; i < e.length; i++)
                    (a = e[i]),
                      (r = c(a.createdOn)),
                      n.hasOwnProperty(a.universeId)
                        ? (((o = n[a.universeId]).updateMessage = a.content),
                          (o.createdOn = r),
                          (o.createdOnKey = a.createdOnKey))
                        : (n[a.universeId] = {
                            ...
                            truncatedGameName:
                              ...
                              l &&
                                l.length > s &&
                                (u = "".concat(l.substr(0, s - 3), "...")),
                              u),
                            isPlayable: null,
                            gameLinkUrl: a.rootPlaceId
                              ? t.getAbsoluteUrl(
                                  "/games/"
                                    .concat(
                                      a.rootPlaceId,
                                      "?originatorType=GameUpdateNotification&originatorId=",
                                    )
                                    .concat(r),
                                )
                              : null,
                            gameLinkUrlForApp: a.rootPlaceId
                              ? "games/"
                                  .concat(
                                    a.rootPlaceId,
                                    "?originatorType=GameUpdateNotification&originatorId=",
            ...
            fillGameDetails: function (t) {
              ...
              for (i in t)
                t.hasOwnProperty(i) &&
                  null === (n = t[i]).isPlayable &&
                  o.push(n.rootPlaceId);
              0 !== o.length &&
                e.multiGetPlaceDetailsAsync(o).then(function (e) {
                  if (e)
                    return (
                      a().forEach(e, function (e, i) {
            ...
            aggregateGameUpdateNotifications: function (e, t) {
              ...
              return (
                ...
                a().forEach(e, function (e) {
                  ...
                  e.eventDate &&
                    ((u = c(e.eventDate)),
                    (!i || i < u) && ((i = u), (o = e.eventDate)),
                    (!n || n > u) && (n = u)),
                    a().forEach(e.metadataCollection, function (e) {
                      t.hasOwnProperty(e.UniverseId) &&
                        !s.hasOwnProperty(e.UniverseId) &&
                        (l.metadataCollection.push(e), (s[e.UniverseId] = !0));
                    }),
                    e.eventCount && (r += e.eventCount);
                }),
                (l.eventDate = o),
                (l.minEventDate = new Date(n)),
                (l.eventCount = Math.max(r, l.metadataCollection.length)),
                l.metadataCollection.length > 0 ? l : null
              );
            },
        ...
        (r.$inject = [
          ...
          o.A.factory("gameUpdatesUtility", r),
          (t.default = r);
      },
      5147: function (e, t, i) {
        "use strict";
        ...
        function a(e, t) {
          ...
          return {
            ...
            stringTemplates: {
              ...
              boldDisplayNameLink:
                "<a class='font-caption-header'>{displayname}</a>",
              displayNameLink:
            ...
            newFriends: function (e) {
              return i.get("Message.YouHaveNewFriends", { numberOfFriends: e });
            },
            ...
            friendRequestSentSingle: function (e) {
              return i.get("Message.FriendRequestSentSingle", { userOne: e });
            },
            ...
            confirmAcceptedSingle: function (e) {
              return i.get("Message.ConfirmAcceptedSingle", { userOne: e });
            },
            ...
            confirmSentSingle: function (e) {
              return i.get("Message.ConfirmSentSingle", { userOne: e });
            },
            ...
            directiveTemplatesName: {
              ...
              notificationStreamIndicatorTemplate:
                "notification-stream-indicator",
              ...
              notificationContentViewTemplate:
                "notification-content-view-template",
              gameUpdateTemplate: "game-update-template",
              gameUpdateActionPopoverTemplate:
                "game-update-action-popover-template",
              groupMembershipTemplate: "group-membership",
              notificationStreamBaseViewTemplate:
                "notification-stream-base-view",
              notificationStreamContainerTemplate:
            ...
            gameUpdates: {
              formatDisplayTextDouble: function (e, t) {
                return i.get("Message.AggregatedGameUpdateDouble", {
                  gameOne: "<span class='font-caption-header'>".concat(
                    e,
                    "</span>",
                  ),
                  gameTwo: "<span class='font-caption-header'>".concat(
                    t,
                    "</span>",
                  ),
                });
        ...
        (a.$inject = ["$log", "languageResource"]),
          n.A.factory("layoutLibraryService", a),
          (t.default = a);
      },
      3061: function (e, t, i) {
        "use strict";
          ...
          return {
            endpoints: {
              ...
              getAccountSettingsPolicy: {
                url: "".concat(
                  n.EnvironmentUrls.universalAppConfigurationApi,
                  "/v1/behaviors/account-settings-ui/content",
                ),
                withCredentials: !0,
                noCache: !1,
              },
            ...
            acceptFriendV2: function (t) {
              var i = {
                url: ""
                  .concat(o, "/v1/users/")
                  .concat(t, "/accept-friend-request"),
                withCredentials: !0,
              };
              return e.httpPost(i);
            },
            ignoreFriendV2: function (t) {
              var i = {
                url: ""
                  .concat(o, "/v1/users/")
                  .concat(t, "/decline-friend-request"),
                withCredentials: !0,
              };
              return e.httpPost(i);
            },
            updateNotificationSettings: function (t, i) {
              ...
              return (
                a.push(n),
                e.httpPost(this.endpoints.updateNotificationSettings, a)
              );
            },
          };
        }
        (o.$inject = ["httpService", "$log", "urlService"]),
          a.A.factory("notificationStreamService", o),
          (t.default = o);
      },
      2521: function (e, t, i) {
        "use strict";
        ...
        function s(e, t, i) {
          ...
          return {
            ...
            layout: {
              ...
              settingLink: n.Endpoints
                ? n.Endpoints.getAbsoluteUrl(c.settingLink)
                : c.settingLink,
              groupLink: n.Endpoints
                ? n.Endpoints.getAbsoluteUrl(c.groupLink)
                : c.groupLink,
              friendRequestLink: n.Endpoints
                ? n.Endpoints.getAbsoluteUrl(c.friendRequestLink)
                : c.friendRequestLink,
              bannerEnabled: !1,
            ...
            library: {
              ...
              isTouch:
                !!n.DeviceFeatureDetection && n.DeviceFeatureDetection.isTouch,
              eventStreamMetaData: {},
              gameUpdateModels: {},
            ...
            getAbsoluteUrl: function (e, t) {
              return n.Endpoints
                ? n.Endpoints.generateAbsoluteUrl(e, t, !0)
                : getFormatString(e, t);
            },
            ...
            isCardClickable: function (e) {
              switch (e.notificationSourceType) {
                case o.friendRequestAccepted:
                  return (
                    e.eventCount > 1 ||
                    (1 === e.eventCount && 0 === e.metadataCollection.length)
                  );
            ...
            normalizeUser: function (e, t) {
              var i = { userId: null, userName: null, displayName: null };
              switch (e) {
                case o.friendRequestReceived:
                  (i.userId = t.SenderUserId),
                    (i.userName = t.SenderUserName),
                    (i.displayName = t.SenderDisplayName);
                  break;
                case o.friendRequestAccepted:
                  (i.userId = t.AccepterUserId),
                    (i.userName = t.AccepterUserName),
                    (i.displayName = t.AccepterDisplayName);
                  break;
                case o.privateMessageReceived:
                  (i.userId = t.AuthorUserId),
                    (i.userName = t.AuthorUserName),
                    (i.displayName = t.AuthorDisplayName);
                case o.developerMetricsAvailable:
                case o.test:
              }
              return i;
      ...
      2833: function (e) {
        e.exports =
          '<div class="notification-content-container"> <div class="notification-image-container"> <div ng-if="groupMembershipLayout.groupId !== null" title="{{groupMembershipLayout.groupName}}"> <a ng-href="{{groupMembershipLayout.groupLink}}" type="goToGroupPage" click-in-card onclick="event.stopPropagation()"> <thumbnail-2d class="notification-icon" thumbnail-target-id="groupMembershipLayout.groupId" thumbnail-type="thumbnailTypes.groupIcon"> </thumbnail-2d> </a> </div> </div> <div class="notification-item-content"> <div class="notification-data-container"> <span class="font-caption-body text notification-display-text" ng-bind-html="notificationDisplayText"> </span> <div class="text-date-hint" ng-bind="notification.eventDate | datetime: \'full\'"></div> </div> </div> </div> ';
      },
      3193: function (e) {
        e.exports =
  ...
  (i.n = function (e) {
    ...
    (function () {
      ...
      t().element(function () {
        ...
        (0, n.importFilesUnderPath)(i(8118)),
        (0, n.importFilesUnderPath)(i(2444)),
        (0, n.importFilesUnderPath)(i(3195)),
        (0, n.importFilesUnderPath)(i(7662)),
        (0, n.importFilesUnderPath)(i(9841));
      var c = i(9982);
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("NotificationStream");
