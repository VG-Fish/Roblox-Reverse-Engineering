!(function () {
  var e = {
      ...
      5098: function (e, r, n) {
        var t = {
          "./directives/templates/people.html": 619,
          "./directives/templates/peopleInfoCard.html": 9245,
          "./directives/templates/peopleList.html": 839,
          "./directives/templates/peopleListContainer.html": 5212,
        };
        function a(e) {
          var r = i(e);
          return n(r);
        ...
        var t = n(7577),
          ...
          i = {
            ...
            hoverPopoverParams: {
              ...
              isDisabled:
                !!t.DeviceMeta &&
                (!(0, t.DeviceMeta)().isDesktop ||
                  (0, t.DeviceMeta)().isUWPApp),
            },
          ...
          (e.clickAvatar = function (e, r) {
            ...
            (e.updatePresenceStatus = function (r) {
              for (var n = [], t = 0; t < r.length; t++) {
                var i = r[t];
                i.rootPlaceId &&
                  !e.library.placesDict[i.rootPlaceId] &&
                  n.push(i.rootPlaceId),
                  e.updatePresenceData(i);
              }
              n.length > 0 &&
                a().isFunction(e.setPlaceDetails) &&
                e.setPlaceDetails(n);
            }),
        ...
        function s(e, r, n) {
          (e.setupHoverPopover = function () {
            (e.peopleInfoCardPlacement = "bottom"),
              ...
              (e.hoverPopoverParams.triggerSelector = "#people-".concat(
                e.friend.id,
              )),
              (e.hoverPopoverParams.hoverPopoverSelector =
                ".people-info-".concat(e.friend.id)),
        ...
        function s(e, r, n, t, s, o, l, c, d) {
          (e.sendEventStream = function (r, n) {
            ...
            (e.sendGamePlayEvent = function (e) {
              c.sendGamePlayEvent(
                n.eventStreamParams.gamePlayIntentInPeopleList.ctx,
                e,
              );
            }),
            (e.sendGameImpressionEvent = function (r, t, a) {
              var s = n.eventStreamParams.pageContexts,
                o =
                  i.sessionStorageService.getEventTracker().homePageSessionInfo,
                l = {
              ...
              switch (i.buttonLayout.type) {
                case s.join.type:
                  var c = e.friend.presence.gameId,
                    u = e.friend.id,
                    p = d.buildPlayGameProperties(
                      a,
                      e.friend.presence.placeId,
                      c,
                      u,
                    );
                  (o.gameInstanceId = c),
                    (o.friendId = e.friend.id),
                    (o.position = e.$index);
                  var f = {
            ...
            (e.goToGameDetails = function (r) {
              ...
              var f = {
                  ...
                  position: 0,
                  homePageSessionInfo:
                    i.sessionStorageService.getEventTracker()
                      .homePageSessionInfo,
                },
                m = ""
            ...
            (e.goToProfilePage = function () {
              e.sendEventStream(n.eventStreamParams.goToProfileInPeopleList),
                (o.location.href = a.urlService.getAbsoluteUrl(
                  e.friend.profileUrl,
                ));
            }),
            (e.init = function () {
      ...
      6507: function (e, r, n) {
        ...
        function d(e, r, n, t, l, d, u, p, f) {
          function m() {
            var e = (0, c.c)();
            return (
              !(null !== e || !i.CurrentUser) || e === i.CurrentUser.userId
            );
          }
          function v() {
            try {
          ...
          (e.setPlaceDetails = function (r) {
                ...
                if (r)
                  switch (((e.library.placesDict[n] = r), r.reasonProhibited)) {
                    case u.reasonProhibitedMessage.None:
                      e.library.placesDict[n].buttonLayout = a().copy(
                        l.playButtons.join,
                      );
                      break;
            ...
            (e.updatePresenceData = function (r) {
              ...
              switch (r.userPresenceType) {
                ...
                case n.ingame.status:
                  (r.className = l.presenceTypes.ingame.className),
                    r.rootPlaceId &&
                      (r.placeUrl = l.getGameDetailsPageUrl(r.rootPlaceId));
                  break;
              ...
              e.library.friendsDict[r.userId] ||
                (e.library.friendsDict[r.userId] = {}),
              ...
              t.shouldGetPresenceData
                ...
                : (e.library.isForCurrentUsersFriends ||
                    r.sort(function (r, n) {
                      ...
                      return t.name.toLowerCase() > a.name.toLowerCase()
                        ? 1
                        : -1;
                    }),
        ...
        var t = n(7577),
          ...
          i = n
            ...
            .config([
              ...
              function (e) {
                var r =
                  new t.TranslationResourceProvider().getTranslationResource(
                    "Feature.PeopleList",
                  );
        ...
        function a(e, r, n, t) {
          ...
          return {
            ...
            getPresences: function (e) {
              ...
              return this.buildBatchPromises(e, n, a.getPresences, !0).then(
                function (e) {
                  if (e && e.length > 0) {
                    var r = [];
                    return (
          ...
          return {
            ...
            multiGetPlaceDetails: function (e) {
              ...
              return n.httpGet(a.multiGetPlaceDetails, r).then(function (e) {
                ...
                return (
                  angular.forEach(e, function (e) {
                    e && e.imageToken && r.push(e.imageToken),
                      (n[e.placeId] = e);
                  }),
                  n
                );
          ...
          return {
            sortFriendsByOnlineOffline: function (r) {
              ...
              angular.forEach(r.friendsDict, function (e) {
                e.presence && e.presence.userPresenceType > 0
                  ? t.push(e)
                  : a.push(e);
              }),
                (t = n(t, "+name")),
            ...
            sortFriendsByPresenceType: function (n) {
              ...
              angular.forEach(n.friendsDict, function (e) {
                ...
                (s = t(s, "+name")),
                (o = t(o, "+name")),
                (s = (s = (s = s.concat(a)).concat(o)).concat(i)).forEach(
                  function (e) {
...
//# sourceMappingURL=https://js.rbxcdn.com/d8f92d3e9c037b35f834d7c35672bbd2-peopleList.bundle.min.js.map
