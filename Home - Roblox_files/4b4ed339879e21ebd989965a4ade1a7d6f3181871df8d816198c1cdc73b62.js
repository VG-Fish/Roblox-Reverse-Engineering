!(function () {
  var r = {
      ...
      4: function (e, t, r) {
        ...
        var E = /([[\].#*$><+~=|^:(),"'`\s])/g,
          ...
          O = (function () {
            ...
            return (
              (e.prototype.prop = function (e, t, r) {
                ...
                t = r && t;
                if (
                  (t ? delete this.style[e] : (this.style[e] = i),
            ...
            function e(e, t, r) {
              ...
              return (
                i
                  ? (n.selectorText = i)
                  : !1 !== e &&
                    ((n.id = r(p(p(n)), t)), (n.selectorText = "." + _(n.id))),
                n
              );
            }
            f(e, o);
            ...
            return (
              ...
              (t.toJSON = function () {
                ...
                for (e in this.style) {
                  ...
                  "object" != typeof r
                    ? (t[e] = r)
                    : Array.isArray(r) && (t[e] = S(r));
                }
                return t;
              }),
              (t.toString = function (e) {
                var t = this.options.sheet,
                  e = !!t && t.options.link ? g({}, e, { allowEmpty: !0 }) : e;
          ...
          D = (function () {
            function e(e, t, r) {
              ...
              var n,
                e = (this.key = e).match(B);
              for (n in ((this.at = e ? e[1] : "unknown"),
              (this.query = r.name || "@" + this.at),
              (this.options = r),
              (this.rules = new te(g({}, r, { parent: this }))),
              t))
          ...
          U = (function () {
            function e(e, t, r) {
              ...
              var i,
                o = (this.options = r).scoped,
                e = r.sheet,
                n = r.generateId;
              for (i in ((this.id = !1 === o ? this.name : _(n(this, e))),
              (this.rules = new te(g({}, r, { parent: this }))),
              t))
                this.rules.add(i, t[i], g({}, r, { parent: this }));
              this.rules.process();
            }
            return (
            ...
            return (
              (e.add = function (e, t, r) {
                var n = this.options,
                  ...
                  r = e;
                e in this.raw && (r = e + "-d" + this.counter++),
                  (this.raw[r] = t),
                  r in this.classes && (n.selector = "." + _(this.classes[r]));
                t = v(r, t, n);
                if (!t) return null;
                this.register(t);
              ...
              (e.replace = function (e, t, r) {
                ...
                n = r;
                return (
                  -1 !== i && (n = g({}, r, { index: i })), this.add(e, t, n)
                );
              }),
              (e.get = function (e) {
                return this.map[e];
              ...
              (e.register = function (e) {
                (this.map[e.key] = e) instanceof P
                  ? (this.map[e.selector] = e).id &&
              ...
              (e.update = function (e, t, r) {
                ...
                if (
                  ("string" == typeof (arguments.length <= 0 ? void 0 : e)
                    ? ((n = arguments.length <= 0 ? void 0 : e),
                      (i = arguments.length <= 1 ? void 0 : t),
                      (o = arguments.length <= 2 ? void 0 : r))
                    : ((i = arguments.length <= 0 ? void 0 : e),
                  ...
                  for (var s = 0; s < this.index.length; s++)
                    this.updateOne(this.index[s], i, o);
              }),
              (e.updateOne = function (e, t, r) {
                ...
                if (e.rules instanceof d) e.rules.update(t, r);
                  ...
                  var o = e.style;
                  if (
                    (i.onUpdate(t, e, n, r), r.process && o && o !== e.style)
                  ) {
                ...
                return (
                  ...
                  this.attached
                    ? this.deployed &&
                      ...
                      (r
                        ? n.renderable &&
                          this.renderer.replaceRule(n.renderable, r)
        ...
        function le(i) {
          ...
          return function (e, t) {
            ...
            return (
              t &&
                (t.options.classNamePrefix && (n = t.options.classNamePrefix),
                null != t.options.jss.id && (r = String(t.options.jss.id))),
              i.minify
                ? "" + (n || "c") + pe + r + o
                : n + e.key + "-" + pe + (r ? "-" + r : "") + "-" + o
            );
        ...
        function ce(e, t, r) {
          try {
            var n,
              i = r;
            Array.isArray(r) && (i = S(r)),
              e.attributeStyleMap
                ? e.attributeStyleMap.set(t, i)
                : ((i =
                    -1 < (n = i ? i.indexOf("!important") : -1)
                      ? i.substr(0, n - 1)
                      : i),
                  e.style.setProperty(t, i, -1 < n ? "important" : ""));
          } catch (e) {
            return !1;
          }
          return !0;
        ...
        function ye(e) {
          ...
          if (e && "string" == typeof e) {
            ...
            if (e) return { parent: e.parentNode, node: e.nextSibling };
          }
          return !1;
        }
        function me(e, t, r) {
            ...
            return (
              (t.attach = function () {
                ...
                !this.element.parentNode &&
                  this.sheet &&
                  ((r = this.element),
                  (e = this.sheet.options),
                  (t = e.insertionPoint),
                  !1 !== (e = ye(e)) && e.parent
                    ? e.parent.insertBefore(r, e.node)
                    : t && "number" == typeof t.nodeType
                      ? (e = t.parentNode) && e.insertBefore(r, t.nextSibling)
                      : ge().appendChild(r),
                  (r = Boolean(this.sheet && this.sheet.deployed)),
              ...
              (t.detach = function () {
                var e;
                this.sheet &&
                  ((e = this.element.parentNode) && e.removeChild(this.element),
              ...
              (t.insertRule = function (e, t, r) {
                if ((void 0 === r && (r = this.element.sheet), e.rules)) {
                  ...
                  if ("conditional" === e.type || "keyframes" === e.type) {
                    var o = ve(r, t);
                    if (!1 === (i = me(r, n.toString({ children: !1 }), o)))
                      return !1;
                ...
                return (
                  !1 !== i &&
                  ((this.hasInsertedRules = !0), this.refCssRule(e, t, i), i)
                );
              }),
              ...
              (t.deleteRule = function (e) {
                var t = this.element.sheet,
                  e = this.indexOf(e);
                return (
                  -1 !== e && (t.deleteRule(e), this.cssRules.splice(e, 1), !0)
                );
              }),
              (t.indexOf = function (e) {
        ...
        var Re = Date.now(),
          ...
          Te = function () {
            return {
              ...
              onUpdate: function (e, t, r, n) {
                ...
                t && (i.style = t(e) || {});
                var o = i[Ie];
                if (o) for (var s in o) i.prop(s, o[s](e), n);
              },
            };
          },
          Oe = "@global",
          ...
          ke = (function () {
            function e(e, t, r) {
              ...
              this.rule = r.jss.createRule(e, t, g({}, r, { parent: this }));
            }
            return (
              (e.prototype.toString = function (e) {
          ...
          Be = /\s*,\s*/g;
        function De(e, t) {
          for (var r = e.split(Be), n = "", i = 0; i < r.length; i++)
            ...
            return {
              onCreateRule: function (e, t, r) {
                return e
                  ? e === Oe
                    ? new Ae(e, t, r)
                    : "@" === e[0] && e.substr(0, Pe.length) === Pe
                      ? new ke(e, t, r)
                      : ((t = r.parent) &&
                          ("global" === t.type ||
                            (t.options.parent &&
                              "global" === t.options.parent.type)) &&
                          (r.scoped = !1),
              ...
              onProcessRule: function (e, t) {
                "style" === e.type &&
                  ...
                  (function (e, t) {
                    ...
                    for (r in o)
                      "@" === r[0] &&
                        r.substr(0, Oe.length) === Oe &&
                        ((n = De(r.substr(Oe.length), e.selector)),
                        t.addRule(n, o[r], g({}, i, { selector: n })),
                        delete o[r]);
                  })(e, t));
              },
            };
                ...
                for (i in e) {
                  ...
                  (d || f) &&
                    ...
                    (n = (s = n)
                      ? g({}, s, { index: s.index + 1 })
                      : ((s =
                          void 0 === (s = c.options.nestingLevel) ? 1 : s + 1),
                        delete (c = g({}, c.options, {
                          nestingLevel: s,
                          index: o.indexOf(c) + 1,
                        })).name,
                        c)),
                    d
                      ? ((u =
                        ...
                        (c = (c = (function (e, t) {
                          for (
                            var r = t.split(Ne), n = e.split(Ne), i = "", o = 0;
                            o < r.length;
                            o++
                          )
                          ...
                          return i;
                        })(i, a.selector)).replace(je, u)),
                        (d = a.key + "-" + i),
                        "replaceRule" in l
                          ? l.replaceRule(d, e[i], g({}, n, { selector: c }))
                          : l.addRule(d, e[i], g({}, n, { selector: c })))
                      : f &&
                        l
                          .addRule(i, {}, n)
                          .addRule(a.key, e[i], { selector: a.selector }),
                    delete e[i]);
                }
                return e;
              },
          ...
          return (
            e.fallbacks &&
              (Array.isArray(e.fallbacks)
                ? (r.fallbacks = e.fallbacks.map(We))
                : (r.fallbacks = We(e.fallbacks))),
            r
          );
        }
        var Fe = function () {
        ...
        if (s) {
          var nt,
            it = { Moz: "-moz-", ms: "-ms-", O: "-o-", Webkit: "-webkit-" },
          ...
          "Webkit" === tt &&
            "msHyphens" in ot &&
            ((tt = "ms"), (rt = it.ms), (O = "edge")),
            "Webkit" === tt && "-apple-trailing-word" in ot && (o = "apple");
        }
        var st = { js: tt, css: rt, vendor: o, browser: O, isTouch: A };
        var N = {
          ...
          Re = {
            supportedProperty: function (e, t) {
              return (
                !!/^break-/.test(e) &&
                ("Webkit" === st.js
                  ? "WebkitColumn" + ct(e) in t && st.css + "column-" + e
                  : "Moz" === st.js && "page" + ct(e) in t && "page-" + e)
              );
            },
          },
          _e = {
          ...
          qe = {
            supportedProperty: function (e, t) {
              ...
              return "-" === e[0] || ("-" === e[0] && "-" === e[1])
                ...
                : st.js + r in t
                  ? st.css + e
                  : "Webkit" !== st.js && "Webkit" + r in t && "-webkit-" + e;
            },
          },
          o = {
            supportedProperty: function (e) {
            ...
            A,
            {
              supportedProperty: function (e, t, r) {
                ...
                if (-1 < gt.indexOf(e)) {
                  var n = ht[e];
                  if (!Array.isArray(n))
                    return st.js + ct(n) in t && st.css + n;
                  if (!r) return !1;
        ...
        if (s) {
          ...
          var vt,
            bt = window.getComputedStyle(document.documentElement, "");
        ...
        function St(e, t) {
          ...
          for (
            var r = 0;
            r < yt.length && ((mt[e] = yt[r](e, ft.style, t)), !mt[e]);
            r++
          );
          try {
            ft.style[e] = "";
        ...
        function It(e, t) {
          ...
          if (wt[e]) r = r.replace(_t, Rt);
            ...
            "" === xt.style[e] &&
            ("-ms-flex" === (r = st.css + r) && (xt.style[e] = "-ms-flexbox"),
            (xt.style[e] = r),
            "" === xt.style[e])
          )
            return (Ct[t] = !1);
          ...
          function a(e) {
            for (var t in e) {
              var r,
                ...
                o,
                s = e[t];
              "fallbacks" === t && Array.isArray(s)
                ? (e[t] = s.map(a))
                : ((r = !1),
                  (n = St(t)) && n !== t && (r = !0),
                  (i = !1),
                  (o = It(n, S(s))) && o !== s && (i = !0),
                  (r || i) && (r && delete e[t], (e[n || t] = o || s)));
            }
            return e;
          }
          return {
        ...
        var Tt = function () {
          ...
          return {
            onProcessStyle: function (e, t) {
              if ("style" !== t.type) return e;
              for (
                var r = {}, n = Object.keys(e).sort(o), i = 0;
                i < n.length;
                i++
              )
                r[n[i]] = e[n[i]];
        ...
        function Ot() {
          return {
            plugins: [
              ...
              Fe(),
              Ye(),
              "undefined" == typeof window ? null : Et(),
              Tt(),
            ],
          };
        }
        ...
        function Ut(e) {
          var t = e.children,
            ...
            e = g({}, At().useContext(jt), { disableGeneration: r }, e);
          return (
            !e.jss.options.insertionPoint &&
              n &&
              "undefined" != typeof window &&
              (Nt ||
                ((n = document.head),
                (Nt = document.createComment("mui-inject-first")),
                n.insertBefore(Nt, n.firstChild)),
              (e.jss = we({ plugins: Ot().plugins, insertionPoint: Nt }))),
            At().createElement(jt.Provider, { value: e }, t)
          );
        }
        var Gt = -1e9;
        function Lt(e) {
        ...
        function Wt(e, t) {
          var r,
            ...
            u = e.name;
          a.disableGeneration ||
            ((r = Bt.get(a.sheetsManager, l, s)) ||
              ((r = { refs: 0, staticSheet: null, dynamicStyles: null }),
              Bt.set(a.sheetsManager, l, s, r)),
            ((i = g({}, l.options, a, {
              theme: s,
              flip: "boolean" == typeof a.flip ? a.flip : "rtl" === s.direction,
            })).generateId = i.serverGenerateClassName || i.generateClassName),
            (e = a.sheetsRegistry),
            0 === r.refs &&
              (a.sheetsCache && (n = Bt.get(a.sheetsCache, l, s)),
              (u = l.create(s, u)),
              n ||
                ((n = a.jss.createStyleSheet(u, g({ link: !1 }, i))).attach(),
                a.sheetsCache && Bt.set(a.sheetsCache, l, s, n)),
              e && e.add(n),
              (r.staticSheet = n),
              (r.dynamicStyles = (function e(t) {
                var r,
                  n = null;
                for (r in t) {
                  var i = t[r],
            ...
            r.dynamicStyles
              ? ((i = a.jss.createStyleSheet(
                ...
                e && e.add(i))
              : (o.classes = r.staticSheet.classes),
            (r.refs += 1));
        }
        function Ft(e) {
          var t =
          ...
          return function (e) {
            ...
            return (
                ...
                return (
                  ...
                  function () {
                    ...
                    (r = (e = s).state),
                      ...
                      (o = e.stylesCreator),
                      i.disableGeneration ||
                        (--(t = Bt.get(i.sheetsManager, o, n)).refs,
                        (e = i.sheetsRegistry),
                        0 === t.refs &&
                          (Bt.delete(i.sheetsManager, o, n),
                          i.jss.removeStyleSheet(t.staticSheet),
                          e && e.remove(t.staticSheet)),
                        r.dynamicSheet &&
                          (i.jss.removeStyleSheet(r.dynamicSheet),
                          e && e.remove(r.dynamicSheet)));
                  }
                );
              }),
              (i = [a, h]),
              (r = At().useRef([])),
              (i = At().useMemo(function () {
                return {};
              }, i)),
              r.current !== i && ((r.current = i), (t = n())),
              At().useEffect(
                function () {
                  return function () {
                    t && t();
              ...
              (n = s),
              (i = e.state),
              e.stylesOptions.disableGeneration
                ? r || {}
                : (i.cacheClasses ||
                    (i.cacheClasses = {
                      value: null,
                  ...
                  i.classes !== i.cacheClasses.lastJSS &&
                    ((i.cacheClasses.lastJSS = i.classes), (e = !0)),
                  r !== i.cacheClasses.lastProp &&
                    ((i.cacheClasses.lastProp = r), (e = !0)),
                  e &&
                    (i.cacheClasses.value = kt({
          ...
          return function (r, e) {
            ...
            t = At().forwardRef(function (e, t) {
              ...
              if (
                ...
                return At().cloneElement(
                  o,
                  g({ className: qt(o.props.className, s) }, u),
                );
              if ("function" == typeof o) return o(g({ className: s }, u));
              l = l || f;
              return At().createElement(l, g({ ref: t, className: s }, u), o);
            });
            return Zt()(t, f), t;
          };
        }
                  ...
                  var e,
                    ...
                    e =
                      null === n
                        ? r
                        : ((e = n),
                          "function" != typeof (t = r) ? g({}, e, t) : t(e));
                  return null != e && (e[l] = null !== n), e;
                },
                [r, n],
              )),
              At().createElement(Dt.Provider, { value: e }, t)
            );
          },
          Yt = function (t, e) {
              ...
              var c = Ft(
                ...
                e = At().forwardRef(function (e, t) {
                  ...
                  return (
                    ("string" != typeof u && !l) ||
                      ((e = Mt() || a),
                      u && (o = d({ theme: e, name: u, props: n })),
                      l && !o.theme && (o.theme = e)),
                    At().createElement(s, g({ ref: r || t, classes: i }, o))
                  );
                });
              return Zt()(e, s), e;
            };
          ...
          return function (i) {
            var e = At().forwardRef(function (e, t) {
              var r = e.innerRef,
                n = Pt(e, ["innerRef"]),
                e = Mt() || o;
              return At().createElement(i, g({ theme: e, ref: r || t }, n));
            });
            return Zt()(e, i), e;
          };
        }
      ...
      470: function (e, t, r) {
        ...
        (t.BadgeIcon = function (e) {
          ...
          (l = (0, p.default)(t)),
            ...
            (l = o || (0, f.default)(i, l)),
            (s = a || [s, t].join(" ") || ""),
            (t = (0, h.bindKeyDownA11yButton)(e));
          return d.default.createElement(
            "span",
            c({ role: "button", tabIndex: 0 }, u, {
      ...
      796: function (e, t, r) {
        ...
        (t.__esModule = !0),
          (t.PremiumBadgeIcon =
            t.premiumBadgeIconReactRenderClass =
            t.premiumBadgeIconDataAttrSelector =
            t.PremiumBadgeThemeOptions =
              void 0);
        var l,
          u = n(r(804)),
          c = r(584),
        ...
        ((r = l =
          t.PremiumBadgeThemeOptions ||
          (t.PremiumBadgeThemeOptions = {})).LIGHT_OUTLINE = "lightOutline"),
          (r.DARK_OUTLINE = "darkOutline"),
          (t.premiumBadgeIconDataAttrSelector = "data-rblx-premium-badge-icon"),
          (t.premiumBadgeIconReactRenderClass = "premium-badge-icon");
        ...
        (t.PremiumBadgeIcon = function (e) {
          ...
          t =
            t === l.LIGHT_OUTLINE
              ? f.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_LIGHT
              : f.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_DARK;
      ...
      876: function (e, t, r) {
        ...
        (t.__esModule = !0),
          (t.VerifiedBadgeIcon =
            t.verifiedBadgeIconReactRenderClass =
            t.verifiedBadgeIconDataAttrSelector =
              void 0);
        var a = n(r(804)),
          l = r(584),
          u = r(470),
          c = r(459);
        (t.verifiedBadgeIconDataAttrSelector = "data-rblx-verified-badge-icon"),
          (t.verifiedBadgeIconReactRenderClass = "verified-badge-icon");
      ...
      243: function (e, t) {
        ...
        (t.__esModule = !0),
          (t.BadgeSizes = void 0),
          ((n = r = t.BadgeSizes || (t.BadgeSizes = {})).TITLE = "Title"),
          (n.HEADER = "Header"),
          (n.SUBHEADER = "Subheader"),
          (n.CAPTIONHEADER = "CaptionHeader"),
          (n.FOOTER = "Footer"),
          (t.default = { BadgeSizes: r });
      },
      764: function (e, t, r) {
        "use strict";
        var y =
        ...
        (t.__esModule = !0),
          (t.VerifiedBadgeTextContainer =
            t.verifiedBadgeTextContainerReactRenderClass =
            t.verifiedBadgeIconElDataAttrSelector =
            t.verifiedBadgeTextElDataAttrSelector =
            t.verifiedBadgeTextWrapperDataAttrSelector =
              void 0);
        var m = n(r(804)),
          v = n(r(779)),
          b = n(r(141)),
        ...
        (t.verifiedBadgeTextWrapperDataAttrSelector =
          ...
          (t.verifiedBadgeTextElDataAttrSelector = "data-rblx-badge-text-el"),
          (t.verifiedBadgeIconElDataAttrSelector = "data-rblx-badge-icon-el"),
          (t.verifiedBadgeTextContainerReactRenderClass =
            "verified-badge-text-container");
        var w =
            (((r = {})[t.verifiedBadgeTextWrapperDataAttrSelector] = ""), r),
        ...
        (t.VerifiedBadgeTextContainer = function (e) {
          ...
          (f = (0, b.default)(t)),
            ...
            (h = f.badge),
            (e = void 0 === h ? "" : h),
            (h = f.applyEllipsisTruncation),
            (f = void 0 === h ? "" : h),
            (h = (0, x.bindKeyDownA11yButton)(c)),
            (g = d || (0, v.default)(l, g)),
            (s = p || (0, v.default)(n, s)),
            (o = a || m.default.createElement("span", { className: f }, o)),
            (r = i
              ? m.default.createElement(S.VerifiedBadgeIcon, {
                  size: t,
                  titleText: r,
                })
              : null),
      ...
      862: function (e, t, r) {
        ...
        (t.__esModule = !0),
          (t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_LIGHT =
            t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_DARK =
            ...
            t.VerifiedBadgeTextContainer =
              void 0);
        var i = r(764);
        n(t, i, "VerifiedBadgeTextContainer"),
          n(t, i, "verifiedBadgeTextContainerReactRenderClass");
        i = r(876);
        n(t, i, "VerifiedBadgeIcon"),
          n(t, i, "verifiedBadgeIconReactRenderClass"),
          n(t, r(796), "PremiumBadgeIcon"),
          n(t, r(243), "BadgeSizes");
        r = r(459);
        n(t, r, "VERIFIED_BADGE_SVG_URL_ENCODED_DATA_IMAGE"),
          n(t, r, "PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_DARK"),
          n(t, r, "PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_LIGHT");
      },
      141: function (e, t, r) {
        "use strict";
        ...
        t.default = function (e) {
          e = {
            ...
            textContainer: {
              maxWidth: "calc(100% - ("
                .concat(t.SIZE_CONSTS[e].iconWidth, " + ")
                .concat(t.SIZE_CONSTS[e].marginLeft, "))"),
              width: "min-content",
              ...
              display: "inline-block",
              height: "calc("
                .concat(t.SIZE_CONSTS[e].fontSize, " * ")
                .concat(1.4, ")"),
            },
            imgWrapper: {
              display: "flex",
      ...
      459: function (e, t, r) {
        ...
        (t.__esModule = !0),
          (t.VERIFIED_BADGE_SVG_URL_ENCODED_DATA_IMAGE =
            t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_LIGHT =
            t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_DARK =
            t.PREMIUM_ICON_SVG_DATA_OUTLINE_LIGHT_SVG =
            t.PREMIUM_ICON_SVG_DATA_OUTLINE_DARK_SVG =
            t.VERIFIED_BADGE_RAW_SVG =
              void 0);
        r = r(241);
        (t.VERIFIED_BADGE_RAW_SVG =
          ...
          (t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_DARK = (0,
          r.svgToEncodedDataImageString)(
            t.PREMIUM_ICON_SVG_DATA_OUTLINE_DARK_SVG,
          )),
          (t.PREMIUM_ICON_SVG_URL_ENCODED_DATA_OUTLINE_LIGHT = (0,
          r.svgToEncodedDataImageString)(
            t.PREMIUM_ICON_SVG_DATA_OUTLINE_LIGHT_SVG,
          )),
          (t.VERIFIED_BADGE_SVG_URL_ENCODED_DATA_IMAGE = (0,
          r.svgToEncodedDataImageString)(t.VERIFIED_BADGE_RAW_SVG)),
          (t.default = {
      ...
      241: function (e, t) {
        "use strict";
        (t.__esModule = !0),
          (t.svgToEncodedDataImageString =
            t.getDataImageString =
            t.encodeSVG =
            t.QuoteTypes =
            t.blankSvg =
              void 0);
        ...
        (t.blankSvg =
          ...
          ((n = r = t.QuoteTypes || (t.QuoteTypes = {})).SINGLE = "single"),
          (n.DOUBLE = "double");
        t.encodeSVG = function (e, t) {
          return (e = (e = (e =
            t === r.DOUBLE
              ? e.replace(/"/g, "'")
              : e.replace(/'/g, '"')).replace(/>\s{1,}</g, "><")).replace(
            /\s{2,}/g,
            " ",
      ...
      584: function (e, t) {
        ...
        function r() {}
        (t.__esModule = !0),
          (t.bindKeyDownA11yButton = t.noop = void 0),
          (t.noop = r);
        var n = ["Enter", " "];
  ...
  (S.n = function (e) {
    ...
    (function () {
      ...
      var i = S(804),
        ...
        s = ReactStyleGuide,
        a = S(862),
        c = { common: ["CommonUI.Features"], feature: "Feature.ProfileBadges" },
        t = c,
        d = Roblox;
      function f(e) {
        return (
      ...
      function T() {
        ...
        return (
          d.TranslationResourceProvider &&
            d.Intl &&
            ((s = new d.Intl()),
            (t = new d.TranslationResourceProvider(s)),
            (a = c.feature),
            (l = []
              .concat(f(c.common), [a])
              .filter(function (e) {
            ...
            (e = (u = t.mergeTranslationResources.apply(t, f(l))).get(
              "Creator.VerifiedBadgeIconAccessibilityText",
            )),
            (r = u.get("VerifiedBadgeInfoTitle")),
            (n = u.get("VerifiedBadgeInfo")),
            (i = u.get("VerifiedBadgeInfoLink")),
            (o = u.get("UsernameChangeWithVerifiedBadge")),
            (s = u.get("TwoSVWithVerifiedBadge")),
            (a = u.get("GroupNameChangeWithVerifiedBadge")),
            (l = u.get("DisplayNameChangeWithVerifiedBadge")),
            (u = u.get("action.close"))),
          {
            ...
            translatedVerifiedBadgeGroupNameChangeText:
              a || "the verified badge will be removed.",
      ...
      var P = {
        ...
        b = (0, e.withTranslations)(function (e) {
          ...
          return (
            null == t &&
              (t = e.translate("Creator.VerifiedBadgeIconAccessibilityText")),
            o().createElement(a.VerifiedBadgeIcon, r({}, e, { titleText: t }))
          );
        }, t),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (t = (u = 0 < E.length && void 0 !== E[0] ? E[0] : P)
                            .initCallback),
                          (r = u.overrideIconClass),
                          (n = u.overrideContainerClass),
                          (e.prev = 1),
                          (e.next = 4),
                          window.RobloxBadges.robloxBadgesReadyForRender()
                        );
                      case 4:
                        if (!e.sent) {
                          e.next = 14;
                        ...
                        for (
                          i = document.querySelectorAll(
                            ...
                            0 ===
                              document.querySelectorAll("#".concat(B)).length &&
                              ((l =
                              ...
                              (u = window.React.createElement(
                                window.RobloxBadges.VerifiedBadgeInfoModal,
                              )),
                              window.ReactDOM.render(u, l)),
                            c = T(),
                            d = 0;
                          d < i.length;
                          d++
                        ...
                        for (b = 0; b < o.length; b++) {
                          for (
                            ...
                            (_ = C[w]),
                              ...
                              R
                                ? (x[R] = I)
                                : _ === k && (x.onIconClick = function () {});
                          s({ verifiedBadgeIconProps: x, verifiedBadge: S });
                        }
                      case 14:
                        e.next = 18;
                        break;
      ...
      window.RobloxBadges = {
        ...
        verifiedBadgeTextContainerReactRenderClass:
          a.verifiedBadgeTextContainerReactRenderClass,
          ...
          var n = T(),
            e = o().createElement(
              ...
              o().createElement(
                "div",
                null,
                o().createElement(a.VerifiedBadgeIcon, {
              ...
              o().createElement(
                "div",
                null,
                n.translatedVerifiedBadgeModalBodyText,
              ),
            );
          return o().createElement(
            o().Fragment,
            null,
            o().createElement(s.SimpleModal, {
