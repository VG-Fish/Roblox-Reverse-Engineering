!(function () {
  ...
  var e = {
    ...
    l = {
      ...
      avatarShopRecommendationUrl:
        Roblox.EnvironmentUrls.websiteUrl + "/catalog?Category=15",
      numberOfItemsToDisplay: 6,
    },
    c = { common: [""], feature: "Feature.Recommendations" },
    s = (0, o.withTranslations)(function (e) {
      var t = e.recommendedItems,
        n = e.translate;
      return void 0 === t || t.length < 1
                ...
                t.map(function (e) {
                  return a().createElement(i.ItemCard, {
                    ...
                    thumbnail2d: a().createElement(m.Thumbnail2d, {
                      type: i.ItemCardUtils.checkIfBundle(e.itemType)
                        ? m.ThumbnailTypes.bundleThumbnail
                        : m.ThumbnailTypes.assetThumbnail,
                      targetId: e.itemId,
  ...
  function u() {
    ...
    e
      ? (0, r.render)(a().createElement(s, null), e)
