/*! For license information please see presenceStatus.bundle.min.js.LICENSE.txt */
!(function () {
  "use strict";
  var e,
    t,
  ...
  ((t = e || (e = {}))[(t.Offline = 0)] = "Offline"),
    (t[(t.Online = 1)] = "Online"),
    (t[(t.Game = 2)] = "Game"),
    (t[(t.Studio = 3)] = "Studio"),
    (t[(t.Invisible = 4)] = "Invisible");
  var i = e;
  function o(e) {
    return e &&
      e.__esModule &&
              ...
              return d(this, function (p) {
                switch (p.label) {
                  ...
                  case 1:
                    return r < i.length
                      ? (l = i[r]).pre
                        ? [4, l.pre(f({ fetch: this.fetchApi }, t))]
                        : [3, 3]
                      : [3, 4];
                  case 2:
        ...
        (e.prototype.createFetchParams = function (e, t) {
          ...
          var r,
            i =
              ...
              ((r = e.body), "undefined" != typeof Blob && r instanceof Blob)
                ? e.body
      ...
      return (
        ...
        (e.prototype.post = function (e) {
          var t,
            ...
            i = e.init,
            o = e.response;
          return 403 === o.status && o.headers.has(E)
            ? ((this.currentToken =
                null !== (t = o.headers.get(E)) && void 0 !== t ? t : ""),
    ...
    C = (function () {
      function e(e) {
        this.eventTracker = (function (e) {
          var t = new O({ baseUrl: "https://ecsv2.".concat(e, "/").concat(R) }),
            n = new A(t);
          return {
  ...
  function k(e, t) {
    return null == e ? e : { userIds: m(e, "userIds") ? e.userIds : void 0 };
  }
  function L(e) {
  ...
  function Y(e, t) {
    return null == e
      ? e
      : {
          lastOnlineTimestamps: m(e, "lastOnlineTimestamps")
            ? e.lastOnlineTimestamps.map(G)
            : void 0,
        };
  }
  function Q(e) {
  ...
  function Z(e, t) {
    return null == e
      ? e
      : {
          userPresenceType: m(e, "userPresenceType")
            ? e.userPresenceType
            : void 0,
          ...
          userId: m(e, "userId") ? e.userId : void 0,
          lastOnline: m(e, "lastOnline") ? new Date(e.lastOnline) : void 0,
          invisibleModeExpiry: m(e, "invisibleModeExpiry")
  ...
  function te(e, t) {
    return null == e
      ? e
      : {
          userPresences: m(e, "userPresences")
            ? e.userPresences.map(K)
            : void 0,
        };
  }
  function ne(e) {
    if (void 0 !== e)
      return null === e
        ...
        : {
            userPresences:
              void 0 === e.userPresences ? void 0 : e.userPresences.map(X),
          };
  }
  !(function (e) {
    (e[(e.NUMBER_0 = 0)] = "NUMBER_0"),
      (e[(e.NUMBER_1 = 1)] = "NUMBER_1"),
      (e[(e.NUMBER_2 = 2)] = "NUMBER_2"),
      (e[(e.NUMBER_3 = 3)] = "NUMBER_3"),
      (e[(e.NUMBER_4 = 4)] = "NUMBER_4");
  })(x || (x = {}));
  var re,
    ie,
    oe,
    ...
    fe = {
      presenceStatusToClassName:
        ...
        (re[i.Game] = "game"),
        (re[i.Studio] = "studio"),
        (re[i.Invisible] = "invisible-mode"),
        re),
      presenceStatusToAngularTranslation:
        (((ie = {})[i.Offline] = "Label.Offline"),
        (ie[i.Online] = "Label.Online"),
        (ie[i.Game] = ""),
        (ie[i.Studio] = ""),
        (ie[i.Invisible] = "Label.Invisible"),
        ie),
      presenceStatusResponseToPresenceStatus:
        (((oe = {})[le.NUMBER_0] = i.Offline),
        (oe[le.NUMBER_1] = i.Online),
        (oe[le.NUMBER_2] = i.Game),
        (oe[le.NUMBER_3] = i.Studio),
        (oe[le.NUMBER_4] = i.Invisible),
        oe),
    };
  function pe(e, t, n, r) {
    return new (n || (n = Promise))(function (i, o) {
  ...
  for (
    var Ae,
          ...
          (e.prototype.handleBatchResult = function (e, t, n, r) {
            ...
            t.forEach(function (e) {
              if (i.completeItems.has(e.key))
                ...
                n !== xe.unretriableFailure
              ) {
                var t = (function (e, t) {
                  return t.getFailureCooldown ? t.getFailureCooldown(e) : 1e3;
                })(e.retryAttempts, r);
                (o = o > 0 ? Math.min(o, t) : t),
                  e.retryAttempts + 1 <= r.maxRetryAttempts
                    ? ((e.retryAttempts += 1),
                      (e.queueAfter = a + t),
                      i.requestQueue.unshift(e))
                    : e.reject(xe.maxAttemptsReached);
              } else e.reject(n);
            });
            var s = 250;
            r && r.processBatchWaitTime && (s = r.processBatchWaitTime),
              o > 0 &&
                setTimeout(function () {
      ...
      Me = (function () {
        function e() {
          (this.createExponentialBackoffCooldown = Pe),
        ...
        return (
          (e.prototype.createRequestProcessor = function (e, t, n) {
            var r = Oe({}, n);
            return (
              r.processBatchWaitTime || (r.processBatchWaitTime = 250),
    ...
    Ne.push((ke + 256).toString(16).substr(1));
  var Le,
    Ue = new ce.v1.PresenceApi(
      new M({
        basePath:
          null !==
            (Ce =
              null ===
                (Re =
                  null === (Ae = window.Roblox) || void 0 === Ae
                    ? void 0
                    : Ae.EnvironmentUrls) || void 0 === Re
                ? void 0
                : Re.presenceApi) && void 0 !== Ce
            ? Ce
  ...
  var _e = Le,
    De = function (e) {
      return e.includes("/profile")
        ? _e.WebProfile
        : e.includes("/search/users")
          ? _e.WebPlayerSearch
          : e.includes("/users/friends")
            ? _e.WebFriends
            : e.includes("/groups")
              ? _e.WebGroups
              : _e.WebNavigation;
    ...
    Fe = function (e) {
      ...
      return {
        userId:
          null !== (t = null == e ? void 0 : e.userId) && void 0 !== t ? t : 0,
        userPresenceType:
          fe.presenceStatusResponseToPresenceStatus[
            null !== (n = null == e ? void 0 : e.userPresenceType) &&
            void 0 !== n
              ? n
              : 0
          ],
        lastLocation:
          null !== (r = null == e ? void 0 : e.lastLocation) && void 0 !== r
            ? r
            : "Website",
  ...
  function qe(e) {
    ...
    e.forEach(function (e) {
      ...
      null === (t = window.localStorage) ||
        void 0 === t ||
        t.setItem(Ve, JSON.stringify(Object.fromEntries(n)));
  }
  function Be(e) {
        ...
        switch (a.label) {
          case 0:
            return (
              ...
              [
                4,
                Ue.v1PresenceUsersPost({ userPresenceRequest: { userIds: e } }),
              ]
            );
          case 1:
            return (
              (t = a.sent()),
              (n = (
                null !== (o = t.userPresences) && void 0 !== o ? o : []
              ).map(Fe)).forEach(function (e) {
                var t, n, r, o, a;
                Number.parseInt(
                  null !==
                    (r =
                  ...
                  e.userPresenceType === i.Invisible &&
                  (null ===
                    (a =
                      null === (o = window.Roblox) || void 0 === o
                        ? void 0
                        : o.EventStream) ||
                    void 0 === a ||
  ...
  var He = {
              ...
              switch (v.label) {
                case 0:
                  return (
                    null ===
                      (h =
                        null === (d = window.Roblox) || void 0 === d
                          ? void 0
                          : d.CurrentUser) || void 0 === h
                      ? void 0
                      : h.isAuthenticated
                  )
                    ? ((r = []),
    ...
    Ge = new Me().createRequestProcessor(
      function (e) {
    ...
    ze = {
      subscribeToPresenceChanges: function (e, t, n) {
        e.forEach(function (e) {
          var r;
          We.has(e) || We.set(e, []),
            null === (r = We.get(e)) || void 0 === r || r.push(t),
            n && Ge.queueItem(e).then(t);
        });
      },
        ...
        document.addEventListener("Roblox.Presence.Update", function (e) {
          ...
          t &&
            ...
            t.detail.forEach(function (e) {
              var t;
              He.invalidateUserPresence(e),
                e.userId &&
                  We.has(e.userId) &&
                  (null === (t = We.get(e.userId)) ||
                    void 0 === t ||
  ...
  !(function () {
    ...
    (window.Roblox = window.Roblox || {}),
      ...
      void 0 ===
        (null ===
          (t =
            null === (e = window.Roblox) || void 0 === e
              ? void 0
              : e.Presence) || void 0 === t
          ? void 0
          : t.presenceProvider) &&
        ((window.Roblox.Presence.presenceProvider = ze),
        ze.initializeEventListener());
  })();
  var Je = {
  ...
  function Ye(e, t) {
    ...
    return (
      (0, n.useEffect)(
        function () {
          void 0 !== e &&
            Je.getPresenceProvider().subscribeToPresenceChanges(
              [e],
              o,
              void 0 === t,
            );
  ...
  !(function (e) {
    ...
    function n(e) {
      if (!j(e)) return t;
      F(e.objectMaxDepth) &&
        (t.objectMaxDepth = i(e.objectMaxDepth) ? e.objectMaxDepth : NaN),
    ...
    function se(e, t, n) {
      ...
      if (((n = i(n) ? n : NaN), t)) {
        if (
          ((o = t) && H(o.length) && ee.test(g.call(o))) ||
          ((r = t), "[object ArrayBuffer]" === g.call(r))
        )
          throw b(
            "cpta",
      ...
      function u(e, t, n) {
        ...
        var r,
          i = t.$$hashKey;
        if (W(e)) for (var o = 0, a = e.length; o < a; o++) t.push(c(e[o], n));
        else if (q(e)) for (r in e) t[r] = c(e[r], n);
        else if (e && "function" == typeof e.hasOwnProperty)
          for (r in e) e.hasOwnProperty(r) && (t[r] = c(e[r], n));
        else for (r in e) p.call(e, r) && (t[r] = c(e[r], n));
        return R(t, i), t;
      }
      function c(e, t) {
        if (!j(e)) return e;
        ...
        return (
          void 0 === i && ((i = W(e) ? [] : Object.create(y(e))), (r = !0)),
          a.push(e),
          s.push(i),
          r ? u(e, i, t) : i
        );
    ...
    function ce(e, t) {
      ...
      if (a === r(t) && "object" === a) {
        if (!W(e)) {
          ...
          for (i in t)
            if (!(i in o) && "$" !== i.charAt(0) && F(t[i]) && !J(t[i]))
              return !1;
          return !0;
        }
        if (!W(t)) return !1;
        if ((n = e.length) === t.length) {
          for (i = 0; i < n; i++) if (!ce(e[i], t[i])) return !1;
          return !0;
        }
      }
      return !1;
    ...
    var le = function t() {
      ...
      fe = function t() {
        ...
        for (r = 0; r < a; ++r)
          if (
            ((i = Ae[r]),
            (n = e.document.querySelector("[" + i.replace(":", "\\:") + "jq]")))
          ) {
    ...
    function he(e, t) {
      ...
      return !J(t) || t instanceof RegExp
        ? t
        : n.length
          ? function () {
              return arguments.length
                ? t.apply(e, pe(n, arguments, 0))
                : t.apply(e, n);
            }
          : function () {
    ...
    function _e(e, t, n) {
      return (
        ...
        Ue(
          ...
          t,
          "not a function, got " +
            (e && "object" == r(e) ? e.constructor.name || "Object" : r(e)),
        ),
        e
      );
    }
    ...
    function Ve(e) {
      for (
        ...
        (t || e[i] !== n) && (t || (t = s($.call(e, 0, i))), t.push(n));
      return t || e;
    }
    function Fe() {
    ...
    var Je = /-([a-z])/g,
      Ye = /^-ms-/,
      Qe = { mouseleave: "mouseout", mouseenter: "mouseover" },
      Ke = o("jqLite");
    function Ze(e, t) {
    ...
    function ft(t, n) {
      ...
      if (ct(t)) l.push(n.createTextNode(t));
        ...
        if (
          ...
          (i = (nt.exec(t) || ["", ""])[1].toLowerCase()),
          (s = dt.legacyXHTMLReplacement ? t.replace(rt, "<$1></$2>") : t),
          a < 10)
        )
          for (
            o = ot[i] || ot._default, r.innerHTML = o[1] + s + o[2], u = o[0];
            u--;

          )
            r = r.firstChild;
        else {
          for (u = (o = it[i] || []).length; --u > -1; )
            r.appendChild(e.document.createElement(o[u])), (r = r.firstChild);
          r.innerHTML = s;
        }
    ...
    function $t(e, t) {
      !t && lt(e) && s.cleanData([e]),
        e.querySelectorAll && s.cleanData(e.querySelectorAll("*"));
    }
    function vt(e) {
      var t;
      for (t in e) return !1;
    ...
    function bt(e, t) {
      ...
      return (
        t &&
          !r &&
          ((e.ng339 = n = ++ze),
          (r = We[n] = { events: {}, data: {}, handle: void 0 })),
        r
      );
    }
    function wt(e, t, n) {
    ...
    function Vt(e, t) {
      ...
      var i = r(e);
      return "function" === i || ("object" === i && null !== e)
        ? (e.$$hashKey = i + ":" + (t || A)())
        : i + ":" + e;
    }
    T(
      ...
      T(
        {
          ...
          isolateScope: function (e) {
            return (
              s.data(e, "$isolateScope") || s.data(e, "$isolateScopeNoTemplate")
            );
          },
          controller: Ot,
          injector: function (e) {
        ...
        function (e, t) {
          dt.prototype[t] = function (t, n) {
            ...
            if (e !== Rt && V(2 === e.length && e !== Et && e !== Ot ? t : n)) {
              ...
              for (
                var a = e.$dv, s = V(a) ? Math.min(o, 1) : o, u = 0;
                u < s;
                u++
              ) {
                var c = e(this[u], t, n);
          ...
          on: function (e, t, n, r) {
            ...
            if (lt(e)) {
              ...
              for (
                ...
                (t = s[u]), Qe[t] ? (c(Qe[t], _t), c(t, void 0, !0)) : c(t);
            }
          },
          off: gt,
          one: function (e, t, n) {
    ...
    function Zt(e, t) {
      ...
      var n = {},
        ...
        u = (s.$injector = y(s, function (e, t) {
          throw (
            (w.isString(t) && i.push(t),
            Yt("unpr", "Unknown provider: {0}", i.join(" <- ")))
          );
        })),
        l = {},
        f = y(l, function (e, t) {
        ...
        p = f;
      (s["$injector" + r] = { $get: _(f) }), (p.modules = u.modules = Fe());
      var d = g(e);
      return (
      ...
      function $(e, t) {
        if (
          (De(e, "service"), (J(t) || W(t)) && (t = u.instantiate(t)), !t.$get)
        )
          throw Yt(
            "pget",
            ...
            if (!o.get(e)) {
              ...
              try {
                B(e)
                  ? ((t = c(e)),
                    (p.modules[e] = t),
                    (n = n.concat(g(t.requires)).concat(t._runBlocks)),
                    r(t._invokeQueue),
                    r(t._configBlocks))
                  : J(e) || W(e)
                    ? n.push(u.invoke(e))
      ...
      function y(e, o) {
        ...
        function c(e, n, r) {
          for (
            var i = [], o = Zt.$$annotate(e, t, r), a = 0, s = o.length;
            a < s;
            a++
          ) {
            var c = o[a];
          ...
          invoke: function (e, t, n, r) {
            ...
            return (
              ...
              (function (e) {
                ...
                ? (i.unshift(null), new (Function.prototype.bind.apply(e, i))())
                : e.apply(t, i)
            );
          },
    ...
    Zt.$$annotate = function (e, t, n) {
      ...
      if ("function" == typeof e) {
        ...
        W(e)
          ? (_e(e[(i = e.length - 1)], "fn"), (r = e.slice(0, i)))
          : _e(e, "fn", !0);
      return r;
    };
    var en = o("$animate"),
        ...
        this.$get = [
          ...
          function (n, r) {
            ...
            function i(e, t, n) {
              ...
              return (
                t &&
                  T((t = B(t) ? t.split(" ") : W(t) ? t : []), function (t) {
                    t && ((r = !0), (e[t] = n));
                  }),
                r
              );
              ...
              function (e) {
                ...
                return {
                  ...
                  animate: function (t, n, r, i, o) {
                    return (
                      ((o = rn(o)).from = o.from ? P(o.from, n) : n),
                      (o.to = o.to ? P(o.to, r) : r),
    ...
    function mn(t, n) {
        ...
        if (
          (j(e.scope) &&
            (!0 === e.bindToController
              ? ((n.bindToController = $(e.scope, t, !0)),
                (n.isolateScope = {}))
              : (n.isolateScope = $(e.scope, t, !1))),
          j(e.bindToController) &&
            (n.bindToController = $(e.bindToController, t, !0)),
                    ...
                    return (
                      T(r[n], function (r, o) {
                        try {
                          ...
                          J(a)
                            ? (a = { compile: _(a) })
                            : !a.compile && a.link && (a.compile = _(a.link)),
      ...
      (this.addPropertySecurityContext = function (e, t, n) {
        ...
        (function () {
          ...
          e(Wr.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
            e(Wr.CSS, ["*|style"]),
            e(Wr.URL, [
              "area|href",
              "area|ping",
          ...
          function (t, n, h, $, x, O, A, R, C) {
            ...
            function H(e, t) {
              ...
              for (
                ...
                var u = 2 * s;
                (n += R.getTrustedMediaUrl(te(o[u]))),
                  (n += " " + te(o[u + 1]));
              }
              var c = te(o[2 * s]).split(/\s/);
              return (
                (n += R.getTrustedMediaUrl(te(c[0]))),
                2 === c.length && (n += " " + te(c[1])),
                n
              );
            }
            ...
            G.prototype = {
              ...
              $set: function (e, t, n, r) {
                var i = Lt(this.$$element[0], e),
                  ...
                  a = e;
                i
                  ? (this.$$element.prop(e, t), (r = i))
                  : o && ((this[o] = t), (a = o)),
                  (this[e] = t),
                  r
                    ? (this.$attr[e] = r)
                    : (r = this.$attr[e]) || (this.$attr[e] = r = Ne(e, "-")),
                  "img" === ie(this.$$element) &&
                    "srcset" === e &&
                    (this[e] = t = H(t, "$set('srcset', value)")),
                  !1 !== n &&
                    (null === t || V(t)
              ...
              return function (t, n, r) {
                ...
                if (
                  ...
                  a ||
                    ((c = (u = d) && u[0]),
                    (a =
                      c && "foreignobject" !== ie(c) && g.call(c).match(/SVG/)
                        ? "svg"
                        : "html")),
                  (l =
                    "html" !== a
                      ? s(Re(a, s("<div></div>").append(e).html()))
                      : n
                        ? It.clone.call(e)
                        : e),
                  p)
                  ...
                  for (var h in p)
                    l.data("$" + h + "Controller", p[h].instance);
                return (
                  oe.$$addScopeInfo(l, t),
                  n && n(l, t),
                  o && o(t, l, l, f),
            ...
            function se(e, t, n, r, i, o) {
              for (
                ...
                (u = new G()),
                  11 === a && le(e, m, v),
                  (l = (c = pe(e[m], [], u, 0 === m ? r : void 0, i)).length
                    ? ge(c, e[m], u, t, n, null, [], [], o)
                    : null) &&
                    l.scope &&
                    oe.$$addScopeClass(u.$$element),
                  (p =
                    (l && l.terminal) || !(f = e[m].childNodes) || !f.length
                      ? null
                      : se(
                          f,
                          l
              ...
              return d
                ? function (e, n, r, i) {
                    ...
                    if (h) {
                      var v = n.length;
                      for (d = new Array(v), l = 0; l < $.length; l += 3)
                        d[(p = $[l])] = n[p];
                    } else d = n;
            ...
            function le(e, t, n) {
              ...
              if (i.nodeType === qe)
                for (
                  ;
                  (r = o ? i.nextSibling : e[t + 1]) && r.nodeType === qe;
            ...
            function fe(e, t, n) {
              ...
              for (var o in t.$$slots)
                t.$$slots[o] ? (i[o] = fe(e, t.$$slots[o], n)) : (i[o] = null);
              return r;
            }
              ...
              switch (f) {
                case 1:
                    ...
                    (h = (d = g[y]).name),
                      ...
                      (m = ($ = wn(h.toLowerCase())).match(ne))
                        ...
                        : (w = $.match(re)) &&
                          Se(w[1]) &&
                          ((E = h),
                          (S = h.substr(0, h.length - 5) + "end"),
                          (h = h.substr(0, h.length - 6))),
                      x || O
                        ? ((r[$] = v),
                          (p[$] = d.name),
                          x ? Pe(e, t, $, h) : Ie(t, $, h))
                        : ((p[($ = wn(h.toLowerCase()))] = h),
                          (!T && r.hasOwnProperty($)) ||
                            ((r[$] = v), Lt(e, $) && (r[$] = !0)),
                          Me(e, t, v, $, T),
                          we(t, $, "A", i, a, E, S));
                  ...
                  if (
                    ...
                    break;
                  if (
                    (j((l = e.className)) && (l = l.animVal), B(l) && "" !== l)
                  )
                    for (; (s = u.exec(l)); )
                      we(t, ($ = wn(s[2])), "C", i, a) && (r[$] = te(s[3])),
            ...
            function ge(t, n, r, i, o, a, u, c, l) {
              ...
              for (
                ...
                var U = (f = t[k]).$$start,
                  _ = f.$$end;
                if ((U && (R = $e(n, U, _)), (d = void 0), m > f.priority))
                  break;
                if (
                  ((v = f.scope) &&
                    (f.templateUrl ||
                      (j(v)
                        ? (Ae("new/isolated scope", b || g, f, R), (b = f))
                        : Ae("new/isolated scope", b, f, R)),
                    (g = g || f)),
                  (p = f.name),
                  !M &&
                ...
                if (
                  (!f.templateUrl &&
                    f.controller &&
                    ((y = y || Fe()),
                    Ae("'" + p + "' controller", y[p], f, R),
                    (y[p] = f)),
                  (v = f.transclude))
                )
                  if (
                    ((S = !0),
                    f.$$tlb || (Ae("transclusion", E, f, R), (E = f)),
                    "element" === v)
                  )
                    (A = !0),
                      (m = f.priority),
                      (d = R),
                      (R = r.$$element = s(oe.$$createComment(p, r[p]))),
                      (n = R[0]),
                      ke(o, de(d), n),
                      (I = me(N, d, i, m, C && C.name, {
                    ...
                    if (j(v)) {
                      ...
                      T(R.contents(), function (t) {
                        ...
                        n
                          ? ((H[n] = !0),
                            (q[n] =
                              q[n] || e.document.createDocumentFragment()),
                            q[n].appendChild(t))
                          : d.appendChild(t);
                      }),
                      T(H, function (e, t) {
                ...
                if (f.template)
                  if (
                    ...
                    Ae("template", w, f, R),
                    (w = f),
                    (v = J(f.template) ? f.template(R, r) : f.template),
                    (v = ee(v)),
                    f.replace)
                  ) {
                    if (
                      ((C = f),
                      (d = ct(v) ? [] : Sn(Re(f.templateNamespace, te(v)))),
                      (n = d[0]),
                ...
                if (f.templateUrl)
                  (x = !0),
                    ...
                    (w = f),
                    f.replace && (C = f),
                    (ae = xe(t.splice(k, t.length - k), R, r, o, S && I, u, c, {
                  ...
                  try {
                    ...
                    J($)
                      ? re(null, he(ne, $), U, _)
                      : $ && re(he(ne, $.pre), he(ne, $.post), U, _);
                  } catch (e) {
                    h(e, Ee(R));
                  }
                f.terminal &&
                  ((ae.terminal = !0), (m = Math.max(m, f.priority)));
              }
              return (
                (ae.scope = g && !0 === g.scope),
                (ae.transcludeOnThisElement = S),
                (ae.templateOnThisElement = x),
                (ae.transclude = I),
              ...
              function ae(e, t, i, o, a) {
                ...
                for (var R in (n === i
                  ...
                  : (S = new G((E = s(i)), r)),
                ($ = t),
                b ? (d = t.$new(!0)) : g && ($ = t.$parent),
                a &&
                  ((m = function (e, t, n, r) {
                    var i;
                    if (
                      (K(e) || ((r = n), (n = t), (t = e), (e = void 0)),
                      A && (i = v),
                      n || (n = A ? E.parent() : E),
                      !r)
                    )
                ...
                b &&
                  ...
                  oe.$$addScopeClass(E, !0),
                  (d.$$isolateBindings = b.$$isolateBindings),
                  (x = Ve(t, S, d, d.$$isolateBindings, b)).removeWatches &&
                    d.$on("$destroy", x.removeWatches)),
                v)) {
                  var C = y[R],
                    I = v[R],
                    M = C.$$bindings.bindToController;
                  (I.instance = I()),
                    E.data("$" + C.name + "Controller", I.instance),
                    (I.bindingInfo = Ve($, S, I.instance, M, C));
                }
                for (
                  T(y, function (e, t) {
                    var n = e.require;
                  ...
                  _e(
                    ...
                    E,
                    S,
                    p.require && ye(p.directiveName, p.require, E, v),
                    m,
                  );
                var N = t;
                for (
                  b && (b.template || null === b.templateUrl) && (N = d),
                    e && e(N, i.childNodes, void 0, a),
                    l = c.length - 1;
                  l >= 0;
                  l--
                )
            ...
            function be(e, t, n) {
              for (var r = 0, i = e.length; r < i; r++)
                e[r] = k(e[r], { $$isolateScope: t, $$newScope: n });
            }
            function we(e, n, o, a, s, u, c) {
              ...
              if (r.hasOwnProperty(n))
                for (var f, p = t.get(n + i), d = 0, h = p.length; d < h; d++)
                  if (
                    ((f = p[d]),
                    (V(a) || a > f.priority) && -1 !== f.restrict.indexOf(o))
                  ) {
                    if (
                      (u && (f = k(f, { $$start: u, $$end: c })), !f.$$bindings)
                    ) {
              ...
              return (
                ...
                $(m)
                  .then(function (h) {
                    ...
                    for (
                      e.unshift(v),
                        c = ge(e, $, n, i, t, d, o, a, u),
                        T(r, function (e, n) {
                          e === $ && (r[n] = t[0]);
                        }),
                        l = se(t[0].childNodes, i);
                      f.length;
                      ...
                      if (!S.$$destroyed) {
                        if (x !== p) {
                          var C = x.className;
                          (u.hasElementTranscludeDirective && d.replace) ||
                            (R = ht($)),
                            ke(O, s(x), R),
                            Y(s(R), C);
                        }
              ...
              var a = ie(e),
                s = (function (e, t) {
                  return "srcdoc" === t
                    ...
                    : "src" === t || "ngSrc" === t
                      ? -1 ===
                        ["img", "video", "audio", "source", "track"].indexOf(e)
                        ? R.RESOURCE_URL
                        : R.MEDIA_URL
                      : "xlinkHref" === t
                        ? "image" === e
            ...
            function ke(t, n, r) {
              ...
              for (
                s.hasData(a) && (s.data(r, s.data(a)), s(a).off("$destroy")),
                  s.cleanData(d.querySelectorAll("*")),
                  i = 1;
                i < u;
                i++
              )
              ...
              return (
                T(i, function (i, a) {
                  ...
                  switch (i.mode) {
                    ...
                    case "=":
                      ...
                      (g.$stateful = !0),
                        ($ = i.collection
                          ...
                          : e.$watch(x(t[v], g), null, f.literal)),
                        s.push($);
                      break;
                    case "<":
                      if (!p.call(t, v)) {
                    ...
                    case "&":
                      if (
                        (m || p.call(t, v) || De(v, o.name),
                        (f = t.hasOwnProperty(v) ? x(t[v]) : L) === L && m)
                      )
                        break;
                      r[a] = function (t) {
                        return f(e, t);
    ...
    function Sn(e) {
      ...
      for (; t--; ) {
        var n = e[t];
        (8 === n.nodeType ||
          (n.nodeType === qe && "" === n.nodeValue.trim())) &&
          v.call(e, t, 1);
      }
      return e;
    }
                ...
                if (
                  ...
                  (r = e.hasOwnProperty(c)
                    ...
                    : (function (e, t) {
                        if (!t) return e;
                        for (
                          var n, r = t.split("."), i = r.length, o = 0;
                          o < i;
                          o++
                        )
                          (n = r[o]), e && (e = e[n]);
    ...
    var In = function () {
        this.$get = [
          ...
          function (e) {
            return function (t) {
              return (
                t
                  ? !t.nodeType && t instanceof s && (t = t[0])
                  : (t = e[0].body),
                t.offsetWidth + 1
              );
            };
      ...
      Mn = "application/json",
      Nn = { "Content-Type": Mn + ";charset=utf-8" },
      kn = /^\[|^\{(?!\{)/,
      Ln = { "[": /]$/, "{": /}$/ },
      Un = /^\)]\}',?\n/,
      _n = o("$http");
      ...
      if (B(e)) {
        ...
        if (n) {
          var r = t("Content-Type"),
            i = r && 0 === r.indexOf(Mn);
          if (i || ((a = (o = n).match(kn)) && Ln[a[0]].test(o)))
            try {
              e = me(n);
            } catch (t) {
              if (!i) return e;
    ...
    function qn(e) {
      ...
      return (
        B(e)
          ? T(e.split("\n"), function (e) {
              (t = e.indexOf(":")),
                r(d(te(e.substr(0, t))), te(e.substr(t + 1)));
            })
          : j(e) &&
            T(e, function (e, t) {
              r(d(t), te(e));
    ...
    function Wn() {
      ...
      Object.defineProperty(this, "xsrfWhitelistedOrigins", {
        ...
        (this.$get = [
          ...
          "$injector",
          "$sce",
          function (i, a, s, u, c, l, f, p) {
            var $ = u("$http");
            e.paramSerializer = B(e.paramSerializer)
              ? f.get(e.paramSerializer)
              : e.paramSerializer;
            var v = [];
            T(n, function (e) {
            ...
            function y(n) {
              ...
              (r.headers = (function (t) {
                ...
                e: for (n in o) {
                  for (i in ((r = d(n)), a)) if (d(i) === r) continue e;
                  a[n] = o[n];
                }
                return (function (e, t) {
                  var n,
                ...
                (r.method = h(r.method)),
                (r.paramSerializer = B(r.paramSerializer)
                    ...
                    (function (n, r) {
                      ...
                      if (
                        ...
                        (!n.cache && !e.cache) ||
                          ...
                          (i = j(n.cache) ? n.cache : j(e.cache) ? e.cache : $),
                        i &&
                          (F((o = i.get(m)))
                            ? X(o)
                              ? o.then(S, S)
                              : W(o)
                                ? E(o[1], o[0], Be(o[2]), o[3], o[4])
                                : E(o, 200, {}, "OK", "complete")
                            : i.put(m, f)),
                        V(o))
                      ) {
            ...
            return (
              ...
              (function (e) {
                T(arguments, function (e) {
                  y[e] = function (t, n, r) {
                    return y(P({}, r || {}, { method: e, url: t, data: n }));
                  };
                });
              })("post", "put", "patch"),
              (y.defaults = e),
              ...
              if (((a = a || e.url()), "jsonp" === d(i)))
                ...
                g.open(i, a, !0),
                  ...
                  (g.onload = function () {
                    ...
                    0 === n &&
                      (n = t ? 200 : "file" === li(a).protocol ? 404 : 0),
                      E(u, n, t, g.getAllResponseHeaders(), e, "complete");
                  });
                if (
                  ((g.onerror = function () {
        ...
        (this.$get = [
          ...
          function (n, r, i) {
            ...
            function p(s, u, c, p) {
              ...
              p = !!p;
              for (
                var v, m, g, y, b, w = 0, E = [], S = s.length, T = [], x = [];
                w < S;
              ...
              if (
                ...
                var A = function (e) {
                  ...
                  return d
                    ...
                    : (c && T.length > 1 && Yn.throwNoconcat(s), T.join(""));
                };
                return P(
                  function (e) {
                    var t = 0,
    ...
    function ir(e, t) {
      ...
      (t.$$protocol = n.protocol),
        (t.$$host = n.hostname),
        (t.$$port = M(n.port) || nr[n.protocol] || null);
    }
    var or = /^\s*[\\/]{2,}/;
    function ar(e, t, n) {
      ...
      (this.hashPrefix = function (t) {
        ...
        (this.html5Mode = function (e) {
          return Z(e)
            ? ((t.enabled = e), this)
            : j(e)
              ? (Z(e.enabled) && (t.enabled = e.enabled),
                Z(e.requireBase) && (t.requireBase = e.requireBase),
                (Z(e.rewriteLinks) || B(e.rewriteLinks)) &&
        ...
        (this.$get = [
          ...
          function (n, r, i, o, a) {
            ...
            if (t.enabled) {
              ...
              (l =
                (f = d).substring(0, f.indexOf("/", f.indexOf("//") + 2)) +
                (p || "/")),
                (c = i.history ? lr : pr);
            } else (l = cr(d)), (c = fr);
            var h = (function (e) {
            ...
            (u = new c(l, h, "#" + e)).$$parseLinkUrl(d, d),
              (u.$$state = r.state());
                  ...
                  (m || s) &&
                    ...
                    n.$evalAsync(function () {
                      ...
                      u.absUrl() === t &&
                        (r
                          ? (u.$$parse(e), (u.$$state = o))
                          : (s && v(t, a, o === u.$$state ? null : u.$$state),
                            g(e, o)));
                    }));
                }
                u.$$replace = !1;
    ...
    (Tr.Program = "Program"),
      (Tr.ExpressionStatement = "ExpressionStatement"),
      (Tr.AssignmentExpression = "AssignmentExpression"),
      (Tr.ConditionalExpression = "ConditionalExpression"),
      (Tr.LogicalExpression = "LogicalExpression"),
      (Tr.BinaryExpression = "BinaryExpression"),
      (Tr.UnaryExpression = "UnaryExpression"),
      (Tr.CallExpression = "CallExpression"),
      (Tr.MemberExpression = "MemberExpression"),
      (Tr.Identifier = "Identifier"),
      (Tr.Literal = "Literal"),
      (Tr.ArrayExpression = "ArrayExpression"),
      (Tr.Property = "Property"),
      (Tr.ObjectExpression = "ObjectExpression"),
      (Tr.ThisExpression = "ThisExpression"),
      (Tr.LocalsExpression = "LocalsExpression"),
      (Tr.NGValueParameter = "NGValueParameter"),
      (Tr.prototype = {
        ast: function (e) {
        ...
        assignment: function () {
          ...
          if (this.expect("=")) {
            if (!Cr(e))
              throw gr("lval", "Trying to assign a value to a non l-value");
            e = {
              ...
              : this.expect("[")
                ...
                : this.expect("{")
                  ...
                  : this.selfReferential.hasOwnProperty(this.peek().text)
                    ? (e = se(this.selfReferential[this.consume().text]))
        ...
        identifier: function () {
          ...
          return (
            ...
            { type: Tr.Identifier, name: e.text }
          );
        },
        constant: function () {
          return { type: Tr.Literal, value: this.consume().value };
        },
        arrayDeclaration: function () {
          ...
          return this.consume("]"), { type: Tr.ArrayExpression, elements: e };
        },
        object: function () {
          var e,
            t = [];
          ...
          return (
            this.consume("}"), { type: Tr.ObjectExpression, properties: t }
          );
        },
        ...
        consume: function (e) {
          if (0 === this.tokens.length)
            throw gr("ueoe", "Unexpected end of expression: {0}", this.text);
          var t = this.expect(e);
          return (
            t ||
              this.throwError(
        ...
        selfReferential: {
          this: { type: Tr.ThisExpression },
          $locals: { type: Tr.LocalsExpression },
        },
      });
    function Ar(e, t, n) {
      var r,
    ...
    function Pr(e) {
      if (1 === e.body.length && Cr(e.body[0].expression))
        return {
          type: Tr.AssignmentExpression,
          left: e.body[0].expression,
          right: { type: Tr.NGValueParameter },
          operator: "=",
        };
    }
    function Ir(e) {
    ...
    function Nr(e, t, n) {
      (this.ast = new Tr(e, n)),
        (this.astCompiler = n.csp ? new Mr(t) : new Ir(t));
    }
    function kr(e) {
              ...
              switch (r(e)) {
                case "string":
                  return (
                    (e = e.trim()),
                    (i = n[(s = e)]) ||
                      ((i = new Nr(new Sr(a), o, a).parse(e)), (n[s] = d(i))),
                    h(i, t)
                  );
                case "function":
                  return h(e, t);
                ...
                return (
                  ...
                  e.$watch(
                    function (e) {
                      ...
                      return (
                        u(t, s, a.isPure) ||
                          ((o = r(e, void 0, void 0, [t])), (s = t && kr(t))),
                        o
                      );
                    },
                    t,
            ...
            l.prototype = {
              ...
              $watch: function (e, t, r, i) {
                var a = o(e),
                  s = J(t) ? t : L;
                if (a.$$watchDelegate)
                  return a.$$watchDelegate(this, s, r, a, e);
                var u = this,
                  c = u.$$watchers,
                  l = { fn: s, last: w, get: a, exp: i || e, eq: !!r };
                return (
                  (n = null),
              ...
              $digest: function () {
                ...
                m("$digest"),
                  s.$$checkUrlChange(),
                  this === f && null !== r && (s.defer.cancel(r), E()),
                  (n = null);
                do {
                  (l = !1), ($ = T);
          ...
          return (
            (n.literal = (function (e) {
              return (
                0 === e.body.length ||
                (1 === e.body.length &&
                  (e.body[0].expression.type === Tr.Literal ||
                    e.body[0].expression.type === Tr.ArrayExpression ||
                    e.body[0].expression.type === Tr.ObjectExpression))
              );
            })(t.ast)),
            ...
            return (
              ...
              (c[Wr.RESOURCE_URL] = s(c[Wr.URL])),
              {
                ...
                getTrusted: function (e, r) {
                  ...
                  if (
                    (J(r.$$unwrapTrustedValue) &&
                      (r = r.$$unwrapTrustedValue()),
                    e === Wr.MEDIA_URL || e === Wr.URL)
                  )
                    return i(r.toString(), e === Wr.MEDIA_URL);
        ...
        function (e, t) {
          var n = {},
            r =
              ...
              e.history.pushState,
            i = M(
              (/android (\d+)/.exec(d((e.navigator || {}).userAgent)) || [])[1],
            ),
          ...
          function (t, n, r, i, o) {
            function a(s, u) {
              a.totalPendingRequests++,
                (B(s) && !V(n.get(s))) || (s = o.getTrustedResourceUrl(s));
              ...
              return (
                W(c)
                  ...
                  : c === jn && (c = null),
                r
                  .get(s, P({ cache: n, transformResponse: c }, e))
                  .finally(function () {
                    a.totalPendingRequests--;
                  })
                  .then(
    ...
    function li(e) {
      if (!B(e)) return e;
      var t = e;
      a && (si.setAttribute("href", t), (t = si.href)),
      ...
      return (
        !ci && n.indexOf(":") > -1 && (n = "[" + n + "]"),
        {
          ...
          port: si.port,
          pathname:
            "/" === si.pathname.charAt(0) ? si.pathname : "/" + si.pathname,
        }
      );
    }
    function fi(e, t) {
      return (
        (e = li(e)), (t = li(t)), e.protocol === t.protocol && e.host === t.host
      );
    }
    function pi() {
      this.$get = _(e);
    ...
    function mi(e, t, n, r, i, o) {
      ...
      if ("string" === s && "!" === t.charAt(0))
        return !mi(e, t.substring(1), n, r, i);
      if (W(e))
      ...
      switch (a) {
        case "object":
          ...
          if (i) {
            for (u in e)
              if (u.charAt && "$" !== u.charAt(0) && mi(e[u], t, n, r, !0))
                return !0;
    ...
    function Ei(e) {
      ...
      return function (e, n, r) {
        ...
        return null == e
          ? e
          : Ti(e, t.PATTERNS[1], t.GROUP_SEP, t.DECIMAL_SEP, r).replace(i, n);
      };
    }
    function Si(e) {
      var t = e.NUMBER_FORMATS;
      return function (e, n) {
        return null == e
          ? e
          : Ti(e, t.PATTERNS[0], t.GROUP_SEP, t.DECIMAL_SEP, n);
      };
    }
      ...
      if (a) c = "∞";
        ...
        (o = (function (e) {
          var t,
            ...
            a = 0;
          for (
            (n = e.indexOf(bi)) > -1 && (e = e.replace(bi, "")),
              (r = e.search(/e/i)) > 0
                ? (n < 0 && (n = r),
                  (n += +e.slice(r + 1)),
                  (e = e.substring(0, r)))
          ...
          return (
            n > yi && ((t = t.splice(0, yi - 1)), (a = n - 1), (n = 1)),
            { d: t, e: a, i: n }
          );
        })(u)),
          (function (e, t, n, r) {
            ...
            (n = Ni.test(n)
              ...
              : (function (e) {
                  ...
                  if ((n = e.match(t))) {
                    ...
                    n[9] && ((i = M(n[9] + n[10])), (o = M(n[9] + n[11]))),
                      a.call(r, M(n[1]), M(n[2]) - 1, M(n[3]));
                    var u = M(n[4] || 0) - i,
                      c = M(n[5] || 0) - o,
                      l = M(n[6] || 0),
    ...
    function Di() {
      return function (e, t, n) {
        return (
          (t = Math.abs(Number(t)) === 1 / 0 ? Number(t) : M(t)),
          N(t)
            ? e
            : (H(e) && (e = e.toString()),
              S(e)
    ...
    function Fi(e) {
      return function (i, a, s, u) {
        if (null == i) return i;
        if (!S(i))
          throw o("orderBy")("notarray", "Expected array but received: {0}", i);
                  ...
                  return (
                    null === e
                      ...
                      : "object" === i &&
                        (e = (function (e) {
                          return (
                            (J(e.valueOf) && t((e = e.valueOf()))) ||
                              (D(e) && t((e = e.toString()))),
                            e
                          );
                        })(e)),
                    { value: e, type: i, index: n }
                  );
                })(i.get(e), n);
              }),
            };
        ...
        return (
          p.sort(function (e, t) {
            ...
            return (
              (f(e.tieBreaker, t.tieBreaker) || n(e.tieBreaker, t.tieBreaker)) *
              l
            );
          }),
          p.map(function (e) {
      ...
      function n(e, t) {
        ...
        if (r === i) {
          ...
          "string" === r
            ...
            : "object" === r && (j(o) && (o = e.index), j(a) && (a = t.index)),
            o !== a && (n = o < a ? -1 : 1);
        } else
          n =
            "undefined" === r
    ...
    function ji(e) {
      return J(e) && (e = { link: e }), (e.restrict = e.restrict || "AC"), _(e);
    }
    Fi.$inject = ["$parse"];
    var qi = _({
        restrict: "E",
            ...
            return {
              ...
              link: function (r, i, o) {
                var s = e,
                  u = e;
                "href" === e &&
                  "[object SVGAnimatedString]" === g.call(i.prop("href")) &&
                  ((u = "xlinkHref"), (o.$attr[u] = "xlink:href"), (s = null)),
                  o.$set(t, n.getTrustedMediaUrl(o[t])),
                  o.$observe(t, function (t) {
                    t
                      ? (o.$set(u, t), a && s && i.prop(s, o[u]))
                      : "href" === e && o.$set(u, null);
                  });
              },
            };
    ...
    (zi.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"]),
      (zi.prototype = {
        ...
        $setPristine: function () {
          this.$$animate.setClass(this.$$element, zo, Jo + " " + Wi),
            (this.$dirty = !1),
            (this.$pristine = !0),
            (this.$submitted = !1),
            T(this.$$controls, function (e) {
        ...
        $setSubmitted: function () {
          for (var e = this; e.$$parentForm && e.$$parentForm !== Hi; )
            e = e.$$parentForm;
          e.$$setSubmitted();
        },
        $$setSubmitted: function () {
          this.$$animate.addClass(this.$$element, Wi),
            (this.$submitted = !0),
            T(this.$$controls, function (e) {
    ...
    function Ki(e) {
      (e.$$classCache = {}),
        (e.$$classCache[Wo] = !(e.$$classCache[Go] = e.$$element.hasClass(Go)));
    }
    function Zi(e) {
      var t = e.clazz,
        n = e.set,
    ...
    function po(e, t, n, r, i, o) {
      ...
      var c = function (e) {
        if ((a && (o.defer.cancel(a), (a = null)), !u)) {
          var i = t.val(),
            c = e && e.type;
          "password" === s || (n.ngTrim && "false" === n.ngTrim) || (i = te(i)),
      ...
      return function (i, o, a, s, u, c, l, f) {
        ...
        if (
          ...
          s.$formatters.push(function (e) {
            if (e && !G(e))
              throw Xo("datefmt", "Expected `{0}` to be a date", e);
            if (y(e)) {
              p = e;
              ...
              return (
                ...
                (function (e, t) {
                  var n = r;
                  h &&
                    B(s.$options.getOption("timeSecondsFormat")) &&
                    (n = r
                      .replace(
                        "ss.sss",
    ...
    function vo(e, t, n, r, i) {
      var o = t[0];
      (r.$$hasNativeValidators = j(o.validity)) &&
        r.$parsers.push(function (e) {
          var n = t.prop(f) || {};
          ...
          return {
            ...
            link: function (n, r, i, o) {
              if (g.call(r[0]).match(/SVG/))
                return (
                  r.empty(),
                  void t(ft(o.template, e.document).childNodes)(
                    n,
                    function (e) {
                      r.append(e);
                    },
    ...
    (ea.$inject = [
      ...
      (ea.prototype = {
        ...
        $setUntouched: function () {
          (this.$touched = !1),
            (this.$untouched = !0),
            this.$$animate.setClass(this.$$element, Yo, Qo);
        },
        $setTouched: function () {
          (this.$touched = !0),
            (this.$untouched = !1),
            this.$$animate.setClass(this.$$element, Qo, Yo);
        },
        $rollbackViewValue: function () {
        ...
        $$runValidators: function (e, t, n) {
          ...
          !(function () {
            var e = a.$$parserName;
            return V(a.$$parserValid)
              ? (s(e, null), !0)
              : (a.$$parserValid ||
                  (T(a.$validators, function (e, t) {
                    s(t, null);
                  }),
            ...
            : (function () {
              ...
              ? ((r = []),
                (i = !0),
                T(a.$asyncValidators, function (n, o) {
                  var a = n(e, t);
                  if (!X(a))
                    throw Xo(
                      "nopromise",
      ...
      na = [
        ...
        function (e) {
          return {
            ...
            compile: function (t) {
              return (
                t.addClass(zo).addClass(Yo).addClass(Go),
                {
    ...
    var sa = ji({ terminal: !0, priority: 1e3 }),
      ua = o("ngOptions"),
      ca =
              ...
              return function (e, n, o, f, $) {
                ...
                e.$watchCollection(m, function (o) {
                  ...
                  if ((g && (e[g] = o), S(o))) (I = o), (P = b || c);
                    ...
                    for (var _ in ((P = b || l), (I = []), o))
                      p.call(o, _) && "$" !== _.charAt(0) && I.push(_);
                  for (O = I.length, N = new Array(O), f = 0; f < O; f++)
                    if (
                      ...
                      (N[f] = { id: C, scope: void 0, clone: void 0 }),
                        (U[C] = !0);
                    }
                  for (var D in (x && (x[w] = void 0), v)) {
                    if (
                      ((k = Ve((M = v[D]).clone)), t.leave(k), k[0].parentNode)
                    )
                  ...
                  for (f = 0; f < O; f++)
                    if (
                      ((A = o === I ? f : I[f]), (R = o[A]), (M = N[f]).scope)
                    ) {
                      y = L;
                      do {
                        y = y.nextSibling;
                      } while (y && y[r]);
                      s(M) !== y && t.move(Ve(M.clone), null, L),
                        (L = u(M)),
                        a(M.scope, f, w, R, E, A, O);
                    } else
                      $(function (e, n) {
                        M.scope = n;
                        var r = h.cloneNode(!1);
          ...
          return {
            ...
            link: function (t, n, r) {
              t.$watch(r.ngShow, function (t) {
                e[t ? "removeClass" : "addClass"](n, $a, { tempClasses: va });
              });
            },
          };
        },
          ...
          return {
            ...
            link: function (t, n, r) {
              t.$watch(r.ngHide, function (t) {
                e[t ? "addClass" : "removeClass"](n, $a, { tempClasses: va });
              });
            },
          };
        },
                  ...
                  o(
                    function (e, n) {
                      ...
                      (function (e) {
                        for (var t = 0, n = e.length; t < n; t++) {
                          var r = e[t];
                          if (r.nodeType !== qe || r.nodeValue.trim())
                            return !0;
                        }
                      })(e)
                        ? t.append(e)
    ...
    var Ra = [
        ...
        function (t, n) {
          ...
          (r.selectValueMap = {}),
            (r.ngModelCtrl = Oa),
            (r.multiple = !1),
            (r.unknownOption = s(e.document.createElement("option"))),
            (r.hasEmptyOption = !1),
            ...
            n.$attr.ngValue
              ? n.$observe("value", function (e) {
                  var n,
                    i = t.prop("selected");
                  F(u) &&
                    (r.removeOption(s), delete r.selectValueMap[u], (n = !0)),
                    (u = Vt(e)),
                    (s = e),
                  ...
                  (i.multiple = !0),
                    ...
                    (i.writeValue = function (e) {
                      T(t.find("option"), function (t) {
                        var n =
                          !!e &&
                          (oe(e, t.value) || oe(e, i.selectValueMap[t.value]));
    ...
    e.angular.bootstrap
      ...
      : ((function () {
          ...
          if (!ke) {
            var n = fe();
            (u = V(n) ? e.jQuery : n ? e[n] : void 0) && u.fn.on
              ? ((s = u),
                P(u.fn, {
                  scope: It.scope,
                ...
                function (e) {
                  e.provider({ $$sanitizeUri: Hr }),
                    e
                      ...
                      .directive({ ngInclude: qo, input: To })
                      .directive(Bi)
                      .directive(_o),
                    e.provider({
                      $anchorScroll: Xt,
              ...
              (o.strictDi =
                ...
                (function (e) {
                  var t,
                    ...
                    r = Ae.length;
                  for (n = 0; n < r; ++n)
                    if (((t = Ae[n] + "strict-di"), B((t = e.getAttribute(t)))))
                      return t;
                  return null;
                })(r)),
                n(r, i ? [i] : [], o);
          ...
          Je.getPresenceProvider().subscribeToPresenceChanges(
            ...
            function (n) {
              e.$evalAsync(function () {
                (t.presence = n),
                  (t.statusClass =
                    fe.presenceStatusToClassName[t.presence.userPresenceType]),
                  (t.statusLabelTranslation =
                    fe.presenceStatusToAngularTranslation[
  ...
  Qe.component("presenceStatusLabel", Ze),
    Qe.controller("presenceStatusController", ["$scope", Xe]);
  var et = {
      PresenceType: i,
      PresenceStatusIcon: function (e) {
        var t,
          ...
          l = Ye(o, a),
          f =
            null !== (t = null == l ? void 0 : l.userPresenceType) &&
            void 0 !== t
              ? t
              : i.Offline,
          p =
            null !== (r = null == l ? void 0 : l.lastLocation) && void 0 !== r
              ? r
              : "";
                  ...
                  .concat(
                    null ===
                      (r =
                        null === (t = window.Roblox) || void 0 === t
                          ? void 0
                          : t.EnvironmentUrls) || void 0 === r
                      ? void 0
                      : r.websiteUrl,
                    "/games/",
                  )
                  .concat(l.rootPlaceId);
            return n.createElement(
              "a",
              { href: f, className: u(null != c ? c : []) },
              l.lastLocation,
            );
          }
          return a("Label.Online");
        }
        return l.userPresenceType === i.Studio
          ? l.lastLocation
          : l.userPresenceType === i.Invisible
            ? a("Label.Invisible")
            : void 0;
      },
      usePresence: Ye,
    ...
    nt = { presenceChanged: "PresenceChanged" },
    rt = Roblox,
    it = HeaderScripts,
    ot = CoreUtilities,
    at = {
      ...
      getPresences: function (e) {
        var t = {
            url: "".concat(
              rt.EnvironmentUrls.presenceApi,
              "/v1/presence/users",
            ),
            withCredentials: !0,
          },
  ...
  null !== it.authenticatedUser &&
    void 0 !== it.authenticatedUser &&
    it.authenticatedUser.isAuthenticated &&
    document.addEventListener("DOMContentLoaded", function () {
      at.initializeRealTimeSubscriptions();
    }),
    (window.Roblox.Presence = window.Roblox.Presence || {}),
    (window.Roblox.Presence.PresenceTypes = {
      Offline: 0,
      Online: 1,
      InGame: 2,
      InStudio: 3,
