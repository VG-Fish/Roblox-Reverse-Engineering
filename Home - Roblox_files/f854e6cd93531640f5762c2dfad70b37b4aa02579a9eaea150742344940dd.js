...
Roblox.LangDynamic["Feature.Chat"] = {
  ...
  "Label.Group.ThemRepliedToOther":
    "{DISPLAY_NAME_1} replied to {DISPLAY_NAME_2}",
  ...
  "Message.ChatUnavailableRegion":
    "At this time Chat is not available in your region.",
  ...
  RobloxConnectUnavailableWithUser:
    "At this time, Roblox Connect is not available with this user.",
  "Toast.Error.InvalidUserSelected":
    "One or more people in this list can’t be added",
  ...
  "Heading.FirstConversationWithThisUser":
    "First conversation with this person",
  "Label.AddConnections": "Add Connections",
  "Message.AddConnectionsLimit":
    "You can have up to {connectionsNum} Connections in chat group.",
  "Message.MakeConnectionsToChatNPlay":
    "Make Connections to start chatting and partying!",
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected(
    "DynamicLocalizationResourceScript_Feature.Chat",
  );
