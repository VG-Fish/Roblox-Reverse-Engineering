!(function () {
  ...
  function E(e, r) {
    return (t = e).length < 8 || 200 < t.length
      ? c.PasswordBadLength
      : e === r
        ? c.PasswordContainsUsernameError
        : (function (e) {
      ...
      v().createElement(
        ...
        v().createElement(
          ...
          v().createElement(
            ...
            v().createElement("span", { className: "close icon-close" }),
          ),
          v().createElement(
            p.Modal.Title,
            { id: "contained-modal-title-vcenter" },
            r("Heading.AddPassword"),
          ),
        ),
      ),
      v().createElement(
        ...
        v().createElement(
          "div",
          null,
          v().createElement("div", { className: "add-password-modal-image" }),
          v().createElement(
            "div",
            { className: "add-password-modal-body-text" },
            r("Description.AddPasswordModal"),
          ),
          v().createElement(
            "form",
            null,
            ...
            c && v().createElement(d, { passwordError: c, translate: r }),
            v().createElement("input", {
              className: "".concat(
                e ? "input-field-error" : "",
                " form-control input-field password-input ",
            ...
            e && v().createElement(d, { passwordError: e, translate: r }),
          ),
        ),
        v().createElement(
          p.Button,
  ...
  function w(e) {
    ...
    return v().createElement(
      ...
      v().createElement(
        p.Modal.Body,
        null,
        v().createElement("div", { className: "success-modal-image" }),
        v().createElement(
          "div",
          { className: "facebook-sunset-modal-body-text" },
          r("Description.AddPasswordModalSuccess"),
        ),
        v().createElement(
          p.Button,
          {
  ...
  function g(e) {
    ...
    return v().createElement(
      ...
      l
        ? v().createElement(h, { translate: n, handleClickDone: e })
        : v().createElement(f, {
            translate: n,
            onHide: t,
  ...
  function j() {
    var e = {
      ...
      withCredentials: !0,
      url: ""
        .concat(P.EnvironmentUrls.authApi, "/v1/social/")
        .concat("Facebook", "/disconnect"),
    };
    return a.httpService
      .post(e)
      .then(function (e) {
  ...
  function B(e) {
    C.eventStreamService.sendEventWithTarget(
      e.type,
      e.context,
      A(A({}, e.params), {}, { origin: e.origin }),
    );
  }
  ...
  function D(e) {
    ...
    (0, b.useEffect)(function () {
      window.addEventListener(
        ...
        function (e) {
          w({ closeCallback: e.detail.closeCallback }), a(!0);
        },
        !1,
      );
    }, []),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      if ((B(F.setPasswordButtonClick), s || l))
  ...
  D.propTypes = { translate: o().func.isRequired };
  var V = D;
  function H(e) {
    e = e.translate;
    return v().createElement(V, { translate: e });
  }
  H.propTypes = { translate: o().func.isRequired };
...
window.Roblox &&
  ...
  window.Roblox.BundleDetector.bundleDetected("FacebookSunsetModal");
